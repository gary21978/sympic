...
__device__ __noinline__ double
pushJ_B_integralS_comp2_f0z_dif1x_f1y(const double *field, double rx_f0z,
                                       double dix_f0z, double rx_if1x_hi,
                                       double dix_if1x_hi,
                                       double rx_if1x_lo,
                                       double dix_if1x_lo, double rx_f1y,
                                       double dix_f1y) {
...
__device__ __noinline__ double
pushJ_B_integralS_comp0_f0x_dif1y_f1z(const double *field, double rx_f0x,
                                       double dix_f0x, double rx_if1y_hi,
                                       double dix_if1y_hi,
                                       double rx_if1y_lo,
                                       double dix_if1y_lo, double rx_f1z,
                                       double dix_f1z) {
...
__device__ __noinline__ double
pushJ_B_integralS_comp1_f0y_dif1x_f1z(const double *field, double rx_f0y,
                                       double dix_f0y, double rx_if1x_hi,
                                       double dix_if1x_hi,
                                       double rx_if1x_lo,
                                       double dix_if1x_lo, double rx_f1z,
                                       double dix_f1z) {
...
__device__ __noinline__ double
pushJ_B_integralS_comp0_f0x_dif1z_f1y(const double *field, double rx_f0x,
                                       double dix_f0x, double rx_if1z_hi,
                                       double dix_if1z_hi,
                                       double rx_if1z_lo,
                                       double dix_if1z_lo, double rx_f1y,
                                       double dix_f1y) {
...
__device__ __noinline__ double
pushJ_B_integralS_comp1_f0y_dif1z_f1x(const double *field, double rx_f0y,
                                       double dix_f0y, double rx_if1z_hi,
                                       double dix_if1z_hi,
                                       double rx_if1z_lo,
                                       double dix_if1z_lo, double rx_f1x,
                                       double dix_f1x) {
...
__device__ __noinline__ double
pushJ_B_integralS_comp2_f0z_dif1y_f1x(const double *field, double rx_f0z,
                                       double dix_f0z, double rx_if1y_hi,
                                       double dix_if1y_hi,
                                       double rx_if1y_lo,
                                       double dix_if1y_lo, double rx_f1x,
                                       double dix_f1x) {
...
__device__ __noinline__ double
pushJ_E_interp_Ex(const double *shE0, double rx1x, double dix1x, double rx1y,
...
__device__ __noinline__ double
pushJ_E_interp_Ey(const double *shE0, double rx1x, double dix1x, double rx1y,
                  double dix1y, double rx1z, double dix1z) {
...
__device__ __noinline__ double
pushJ_E_interp_Ez(const double *shE0, double rx1x, double dix1x, double rx1y,
                  double dix1y, double rx1z, double dix1z) {
