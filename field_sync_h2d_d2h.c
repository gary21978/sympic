...
int sync_field_h2d(Field3D_Seq *pthis, int syncself) {
  ...
  if (syncself) {
    if ((0 == CD_type)) {
      c_pscmc_mem_sync_h2d((sync_layer_pscmc)[13]);

    } else {
      if ((1 == CD_type)) {
        openmp_pscmc_mem_sync_h2d((sync_layer_pscmc)[13]);

      } else {
        if ((2 == CD_type)) {
          cuda_pscmc_mem_sync_h2d((sync_layer_pscmc)[13]);
    ...
    for (i = 0; (i < NUM_SYNC_LAYER); i++) {
      if ((i != 13)) {
        if ((0 == CD_type)) {
          c_pscmc_mem_sync_h2d((sync_layer_pscmc)[i]);

        } else {
          if ((1 == CD_type)) {
            openmp_pscmc_mem_sync_h2d((sync_layer_pscmc)[i]);

          } else {
            if ((2 == CD_type)) {
              cuda_pscmc_mem_sync_h2d((sync_layer_pscmc)[i]);
...
int sync_field_d2h(Field3D_Seq *pthis, int syncself) {
  ...
  if (syncself) {
    if ((0 == CD_type)) {
      c_pscmc_mem_sync_d2h((sync_layer_pscmc)[13]);

    } else {
      if ((1 == CD_type)) {
        openmp_pscmc_mem_sync_d2h((sync_layer_pscmc)[13]);

      } else {
        if ((2 == CD_type)) {
          cuda_pscmc_mem_sync_d2h((sync_layer_pscmc)[13]);
    ...
    for (i = 0; (i < NUM_SYNC_LAYER); i++) {
      if ((i != 13)) {
        if ((0 == CD_type)) {
          c_pscmc_mem_sync_d2h((sync_layer_pscmc)[i]);

        } else {
          if ((1 == CD_type)) {
            openmp_pscmc_mem_sync_d2h((sync_layer_pscmc)[i]);

          } else {
            if ((2 == CD_type)) {
              cuda_pscmc_mem_sync_d2h((sync_layer_pscmc)[i]);
