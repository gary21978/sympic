...
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_init (openmp_pscmc_env *  pe ,openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ){
	return  0 ;
}
void  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_get_struct_len (size_t *  len ){
((len)[0] = sizeof(openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct ));
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_get_num_compute_units (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ){
	return  	omp_get_max_threads (  )
 ;
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_get_xlen (){
	return  1 ;
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_exec (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,long  scmc_internal_g_xlen ,long  scmc_internal_g_ylen ){
 ...
 * ysingle )
 ...
 ; (xid = 	(  xid + 1 )
	...
	{
	openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_kernel ( 	( kerstr )->inoutput
 , 	( kerstr )->xyzw
 , 	( kerstr )->cu_cache
 , 	( kerstr )->cu_xyzw
 , 	( kerstr )->xoffset
...
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_inoutput (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->inoutput
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_xyzw (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->xyzw
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_cu_cache (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->cu_cache
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_cu_xyzw (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->cu_xyzw
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_xoffset (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->xoffset
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_yoffset (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->yoffset
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_zoffset (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->zoffset
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_fieldE (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->fieldE
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_fieldB (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->fieldB
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_fieldB1 (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->fieldB1
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_FoutJ (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->FoutJ
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_XLEN (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->XLEN
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_YLEN (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->YLEN
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_ZLEN (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->ZLEN
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_ovlp (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->ovlp
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_numvec (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->numvec
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_num_ele (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->num_ele
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_grid_cache_len (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->grid_cache_len
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_cu_cache_length (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->cu_cache_length
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_DELTA_X (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->DELTA_X
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_DELTA_Y (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->DELTA_Y
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_DELTA_Z (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->DELTA_Z
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_Mass0 (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->Mass0
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_Charge0 (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->Charge0
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_Deltat (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->Deltat
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_Tori_X0 (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->Tori_X0
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_r0 (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->r0
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_MIN_R0 (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->MIN_R0
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_Q0 (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->Q0
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_b0 (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->b0
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_scmc_set_parameter_zmid (openmp_geo_nr_Bfield_pushJ_nopush_par_vlo_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->zmid
 = pm->d_data);
}
...
int  openmp_geo_nr_Bfield_pushJ_nopush_par_init (openmp_pscmc_env *  pe ,openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ){
	return  0 ;
}
void  openmp_geo_nr_Bfield_pushJ_nopush_par_get_struct_len (size_t *  len ){
((len)[0] = sizeof(openmp_geo_nr_Bfield_pushJ_nopush_par_struct ));
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_get_num_compute_units (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ){
	return  	omp_get_max_threads (  )
 ;
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_get_xlen (){
	return  1 ;
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_exec (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,long  scmc_internal_g_xlen ,long  scmc_internal_g_ylen ){
 ...
 * ysingle )
 ...
 ; (xid = 	(  xid + 1 )
	...
	{
	openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_kernel ( 	( kerstr )->inoutput
 , 	( kerstr )->xyzw
 , 	( kerstr )->cu_cache
 , 	( kerstr )->cu_xyzw
 , 	( kerstr )->xoffset
...
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_inoutput (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->inoutput
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_xyzw (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->xyzw
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_cu_cache (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->cu_cache
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_cu_xyzw (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->cu_xyzw
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_xoffset (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->xoffset
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_yoffset (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->yoffset
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_zoffset (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->zoffset
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_fieldE (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->fieldE
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_fieldB (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->fieldB
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_fieldB1 (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->fieldB1
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_FoutJ (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->FoutJ
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_XLEN (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->XLEN
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_YLEN (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->YLEN
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_ZLEN (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->ZLEN
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_ovlp (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->ovlp
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_numvec (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->numvec
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_num_ele (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->num_ele
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_grid_cache_len (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->grid_cache_len
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_cu_cache_length (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->cu_cache_length
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_DELTA_X (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->DELTA_X
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_DELTA_Y (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->DELTA_Y
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_DELTA_Z (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->DELTA_Z
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_Mass0 (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->Mass0
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_Charge0 (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->Charge0
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_Deltat (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->Deltat
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_Tori_X0 (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->Tori_X0
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_r0 (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->r0
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_MIN_R0 (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->MIN_R0
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_Q0 (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->Q0
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_b0 (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->b0
 = pm->d_data);
}
int  openmp_geo_nr_Bfield_pushJ_nopush_par_scmc_set_parameter_zmid (openmp_geo_nr_Bfield_pushJ_nopush_par_struct *  kerstr ,openmp_pscmc_mem *  pm ){
(	( kerstr )->zmid
 = pm->d_data);
}
