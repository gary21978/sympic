...
int init_parallel_file_particle_for_mpi_fields_V0(
    Field3D_MPI *pthis, Gaps_IO_DataFile *gid_grid, Gaps_IO_DataFile *gid_cu,
    long *pgcache, long *pcucache, char *pName_grid, char *pName_cu, long numt,
    int ro) {
  ...
  //====================Field3D_MPI
  int64_t pdimarr_grid[4];
  int64_t pdimarr_cu[4];
  {
    ...
    void *blas_yiszero_full_block_kernel =
        (data)->blas_yiszero_full_block_kernel;

    void *blas_yisconst_kernel = (data)->blas_yisconst_kernel;

    void *blas_yisconst_full_block_kernel =
        (data)->blas_yisconst_full_block_kernel;

    void *blas_get_ITG_Potential_kernel = (data)->blas_get_ITG_Potential_kernel;

    void *blas_get_ITG_Potential_full_block_kernel =
        (data)->blas_get_ITG_Potential_full_block_kernel;

    void *blas_invy_kernel = (data)->blas_invy_kernel;

    void *blas_invy_full_block_kernel = (data)->blas_invy_full_block_kernel;

    void *blas_axpby_kernel = (data)->blas_axpby_kernel;

    void *blas_axpby_full_block_kernel = (data)->blas_axpby_full_block_kernel;

    void *blas_axpy_kernel = (data)->blas_axpy_kernel;

    void *blas_axpy_full_block_kernel = (data)->blas_axpy_full_block_kernel;

    void *blas_yisax_kernel = (data)->blas_yisax_kernel;

    void *blas_yisax_full_block_kernel = (data)->blas_yisax_full_block_kernel;

    void *blas_mulxy_kernel = (data)->blas_mulxy_kernel;

    void *blas_mulxy_full_block_kernel = (data)->blas_mulxy_full_block_kernel;

    void *blas_findmax_kernel = (data)->blas_findmax_kernel;

    void *blas_findmax_full_block_kernel =
        (data)->blas_findmax_full_block_kernel;

    void *blas_dot_kernel = (data)->blas_dot_kernel;

    void *blas_dot_full_block_kernel = (data)->blas_dot_full_block_kernel;

    void *blas_sum_kernel = (data)->blas_sum_kernel;

    void *blas_sum_full_block_kernel = (data)->blas_sum_full_block_kernel;

    void *blas_yisax_shrink_kernel = (data)->blas_yisax_shrink_kernel;

    void *blas_yisax_enlarge_kernel = (data)->blas_yisax_enlarge_kernel;

    void *blas_axpy_shrink_kernel = (data)->blas_axpy_shrink_kernel;

    void *blas_axpy_enlarge_kernel = (data)->blas_axpy_enlarge_kernel;

    void *blas_axpby_shrink_kernel = (data)->blas_axpby_shrink_kernel;

    void *blas_axpby_enlarge_kernel = (data)->blas_axpby_enlarge_kernel;
    ...
    //====================Field3D_Seq
    {
      ...
      void **krook_collision_test_kernel =
          (particles)->krook_collision_test_kernel;

      void **nonrel_test_kernel = (particles)->nonrel_test_kernel;

      void **geo_rel_slab_nr_2nd_kernel =
          (particles)->geo_rel_slab_nr_2nd_kernel;

      void **boris_yee_kernel = (particles)->boris_yee_kernel;

      void *cu_swap_l_6_kernel = (particles)->cu_swap_l_6_kernel;

      void *cu_swap_r_6_kernel = (particles)->cu_swap_r_6_kernel;

      void *move_back_kernel_6_kernel = (particles)->move_back_kernel_6_kernel;

      void *cu_swap_l_8_kernel = (particles)->cu_swap_l_8_kernel;

      void *cu_swap_r_8_kernel = (particles)->cu_swap_r_8_kernel;

      void *move_back_kernel_8_kernel = (particles)->move_back_kernel_8_kernel;
      ...
      double Number_particle_per_marker =
          (particles)->Number_particle_per_marker;
      ...
      void *split_pass_x_nopush_kernel =
          (particles)->split_pass_x_nopush_kernel;

      void *split_pass_y_nopush_kernel =
          (particles)->split_pass_y_nopush_kernel;

      void *split_pass_z_nopush_kernel =
          (particles)->split_pass_z_nopush_kernel;

      void *split_pass_x_small_grids_kernel =
          (particles)->split_pass_x_small_grids_kernel;

      void *split_pass_y_small_grids_kernel =
          (particles)->split_pass_y_small_grids_kernel;

      void *split_pass_z_small_grids_kernel =
          (particles)->split_pass_z_small_grids_kernel;

      void *split_pass_x_sg2_small_grids_kernel =
          (particles)->split_pass_x_sg2_small_grids_kernel;

      void *split_pass_y_sg2_small_grids_kernel =
          (particles)->split_pass_y_sg2_small_grids_kernel;

      void *split_pass_z_sg2_small_grids_kernel =
          (particles)->split_pass_z_sg2_small_grids_kernel;

      void *split_pass_E_particle_kernel =
          (particles)->split_pass_E_particle_kernel;
      ...
      void *split_pass_x_vlo_nopush_kernel =
          (particles)->split_pass_x_vlo_nopush_kernel;

      void *split_pass_y_vlo_nopush_kernel =
          (particles)->split_pass_y_vlo_nopush_kernel;

      void *split_pass_z_vlo_nopush_kernel =
          (particles)->split_pass_z_vlo_nopush_kernel;

      void *split_pass_x_vlo_small_grids_kernel =
          (particles)->split_pass_x_vlo_small_grids_kernel;

      void *split_pass_y_vlo_small_grids_kernel =
          (particles)->split_pass_y_vlo_small_grids_kernel;

      void *split_pass_z_vlo_small_grids_kernel =
          (particles)->split_pass_z_vlo_small_grids_kernel;

      void *split_pass_x_vlo_sg2_small_grids_kernel =
          (particles)->split_pass_x_vlo_sg2_small_grids_kernel;

      void *split_pass_y_vlo_sg2_small_grids_kernel =
          (particles)->split_pass_y_vlo_sg2_small_grids_kernel;

      void *split_pass_z_vlo_sg2_small_grids_kernel =
          (particles)->split_pass_z_vlo_sg2_small_grids_kernel;

      void *split_pass_x_vlo_sg2_nopush_small_grids_kernel =
          (particles)->split_pass_x_vlo_sg2_nopush_small_grids_kernel;

      void *split_pass_y_vlo_sg2_nopush_small_grids_kernel =
          (particles)->split_pass_y_vlo_sg2_nopush_small_grids_kernel;

      void *split_pass_z_vlo_sg2_nopush_small_grids_kernel =
          (particles)->split_pass_z_vlo_sg2_nopush_small_grids_kernel;

      void *split_pass_E_particle_vlo_kernel =
          (particles)->split_pass_E_particle_vlo_kernel;
...
int dump_particle_parallel_file_for_mpi_fields_V0(
    Field3D_MPI *pthis, Gaps_IO_DataFile *gid_grid, Gaps_IO_DataFile *gid_cu,
    long *pgcache, long *pcucache, long numt, int use_non_uni_cache) {
  ...
  double r_r_r = (((reduce_dim == 1))
                      ? (r_x_rat)
                      : ((((reduce_dim == 2))
                              ? (r_y_rat)
                              : ((((reduce_dim == 3)) ? (r_z_rat) : (0))))));
    ...
    for ((i = 0); (i < num_spec); (i = (i + 1))) {
      {
        ...
        for ((j = 0); (j < num_runtime); (j = (j + 1))) {
          ...
          void *blas_yiszero_synced_kernel =
              ((data + j))->blas_yiszero_synced_kernel;

          void *blas_mulxy_numele3_kernel =
              ((data + j))->blas_mulxy_numele3_kernel;

          void *blas_yiszero_kernel = ((data + j))->blas_yiszero_kernel;

          void *blas_yiszero_full_block_kernel =
              ((data + j))->blas_yiszero_full_block_kernel;

          void *blas_yisconst_kernel = ((data + j))->blas_yisconst_kernel;

          void *blas_yisconst_full_block_kernel =
              ((data + j))->blas_yisconst_full_block_kernel;

          void *blas_get_ITG_Potential_kernel =
              ((data + j))->blas_get_ITG_Potential_kernel;

          void *blas_get_ITG_Potential_full_block_kernel =
              ((data + j))->blas_get_ITG_Potential_full_block_kernel;

          void *blas_invy_kernel = ((data + j))->blas_invy_kernel;

          void *blas_invy_full_block_kernel =
              ((data + j))->blas_invy_full_block_kernel;

          void *blas_axpby_kernel = ((data + j))->blas_axpby_kernel;

          void *blas_axpby_full_block_kernel =
              ((data + j))->blas_axpby_full_block_kernel;

          void *blas_axpy_kernel = ((data + j))->blas_axpy_kernel;

          void *blas_axpy_full_block_kernel =
              ((data + j))->blas_axpy_full_block_kernel;

          void *blas_yisax_kernel = ((data + j))->blas_yisax_kernel;

          void *blas_yisax_full_block_kernel =
              ((data + j))->blas_yisax_full_block_kernel;

          void *blas_mulxy_kernel = ((data + j))->blas_mulxy_kernel;

          void *blas_mulxy_full_block_kernel =
              ((data + j))->blas_mulxy_full_block_kernel;

          void *blas_findmax_kernel = ((data + j))->blas_findmax_kernel;

          void *blas_findmax_full_block_kernel =
              ((data + j))->blas_findmax_full_block_kernel;

          void *blas_dot_kernel = ((data + j))->blas_dot_kernel;

          void *blas_dot_full_block_kernel =
              ((data + j))->blas_dot_full_block_kernel;

          void *blas_sum_kernel = ((data + j))->blas_sum_kernel;

          void *blas_sum_full_block_kernel =
              ((data + j))->blas_sum_full_block_kernel;

          void *blas_yisax_shrink_kernel =
              ((data + j))->blas_yisax_shrink_kernel;

          void *blas_yisax_enlarge_kernel =
              ((data + j))->blas_yisax_enlarge_kernel;

          void *blas_axpy_shrink_kernel = ((data + j))->blas_axpy_shrink_kernel;

          void *blas_axpy_enlarge_kernel =
              ((data + j))->blas_axpy_enlarge_kernel;

          void *blas_axpby_shrink_kernel =
              ((data + j))->blas_axpby_shrink_kernel;

          void *blas_axpby_enlarge_kernel =
              ((data + j))->blas_axpby_enlarge_kernel;
          ...
          Field3D_Seq *pfieldE =
              ((particles + (j + (num_runtime * i))))->pfieldE;

          Field3D_Seq *pfieldB =
              ((particles + (j + (num_runtime * i))))->pfieldB;

          Field3D_Seq *pfieldB1 =
              ((particles + (j + (num_runtime * i))))->pfieldB1;

          Field3D_Seq *pFoutJ = ((particles + (j + (num_runtime * i))))->pFoutJ;

          Field3D_Seq *pLFoutJ =
              ((particles + (j + (num_runtime * i))))->pLFoutJ;

          Field3D_Seq *pFoutEN =
              ((particles + (j + (num_runtime * i))))->pFoutEN;

          void **sort_kernel =
              ((particles + (j + (num_runtime * i))))->sort_kernel;


          void **implicit_kernel =
              ((particles + (j + (num_runtime * i))))->implicit_kernel;

          void **rel_1st_kernel =
              ((particles + (j + (num_runtime * i))))->rel_1st_kernel;

          void **krook_collision_test_kernel =
              ((particles + (j + (num_runtime * i))))
                  ->krook_collision_test_kernel;

          void **nonrel_test_kernel =
              ((particles + (j + (num_runtime * i))))->nonrel_test_kernel;

          void **geo_rel_slab_nr_2nd_kernel =
              ((particles + (j + (num_runtime * i))))
                  ->geo_rel_slab_nr_2nd_kernel;

          void **boris_yee_kernel =
              ((particles + (j + (num_runtime * i))))->boris_yee_kernel;

          void *cu_swap_l_6_kernel =
              ((particles + (j + (num_runtime * i))))->cu_swap_l_6_kernel;

          void *cu_swap_r_6_kernel =
              ((particles + (j + (num_runtime * i))))->cu_swap_r_6_kernel;

          void *move_back_kernel_6_kernel =
              ((particles + (j + (num_runtime * i))))
                  ->move_back_kernel_6_kernel;

          void *cu_swap_l_8_kernel =
              ((particles + (j + (num_runtime * i))))->cu_swap_l_8_kernel;

          void *cu_swap_r_8_kernel =
              ((particles + (j + (num_runtime * i))))->cu_swap_r_8_kernel;

          void *move_back_kernel_8_kernel =
              ((particles + (j + (num_runtime * i))))
                  ->move_back_kernel_8_kernel;
          ...
          double Number_particle_per_marker =
              ((particles + (j + (num_runtime * i))))
                  ->Number_particle_per_marker;

          long grid_cache_len =
              ((particles + (j + (num_runtime * i))))->grid_cache_len;

          long cu_cache_length =
              ((particles + (j + (num_runtime * i))))->cu_cache_length;

          void *split_pass_x_kernel =
              ((particles + (j + (num_runtime * i))))->split_pass_x_kernel;

          void *split_pass_y_kernel =
              ((particles + (j + (num_runtime * i))))->split_pass_y_kernel;

          void *split_pass_z_kernel =
              ((particles + (j + (num_runtime * i))))->split_pass_z_kernel;

          void *split_pass_x_nopush_kernel =
              ((particles + (j + (num_runtime * i))))
                  ->split_pass_x_nopush_kernel;

          void *split_pass_y_nopush_kernel =
              ((particles + (j + (num_runtime * i))))
                  ->split_pass_y_nopush_kernel;

          void *split_pass_z_nopush_kernel =
              ((particles + (j + (num_runtime * i))))
                  ->split_pass_z_nopush_kernel;

          void *split_pass_x_small_grids_kernel =
              ((particles + (j + (num_runtime * i))))
                  ->split_pass_x_small_grids_kernel;

          void *split_pass_y_small_grids_kernel =
              ((particles + (j + (num_runtime * i))))
                  ->split_pass_y_small_grids_kernel;

          void *split_pass_z_small_grids_kernel =
              ((particles + (j + (num_runtime * i))))
                  ->split_pass_z_small_grids_kernel;
          ...
          void *split_pass_E_particle_kernel =
              ((particles + (j + (num_runtime * i))))
                  ->split_pass_E_particle_kernel;

          void *split_pass_x_vlo_kernel =
              ((particles + (j + (num_runtime * i))))->split_pass_x_vlo_kernel;

          void *split_pass_y_vlo_kernel =
              ((particles + (j + (num_runtime * i))))->split_pass_y_vlo_kernel;

          void *split_pass_z_vlo_kernel =
              ((particles + (j + (num_runtime * i))))->split_pass_z_vlo_kernel;

          void *split_pass_x_vlo_nopush_kernel =
              ((particles + (j + (num_runtime * i))))
                  ->split_pass_x_vlo_nopush_kernel;

          void *split_pass_y_vlo_nopush_kernel =
              ((particles + (j + (num_runtime * i))))
                  ->split_pass_y_vlo_nopush_kernel;

          void *split_pass_z_vlo_nopush_kernel =
              ((particles + (j + (num_runtime * i))))
                  ->split_pass_z_vlo_nopush_kernel;
          ...
          void *split_pass_E_particle_vlo_kernel =
              ((particles + (j + (num_runtime * i))))
                  ->split_pass_E_particle_vlo_kernel;

          void *dump_ene_num_kernel =
              ((particles + (j + (num_runtime * i))))->dump_ene_num_kernel;

          void *calculate_rho_kernel =
              ((particles + (j + (num_runtime * i))))->calculate_rho_kernel;
          ...
          void *adjoint_vec_pids =
              ((particles + (j + (num_runtime * i))))->adjoint_vec_pids;
...

          {
            ...
            for ((cur_pcid = 0); (cur_pcid < numvec);
                 (cur_pcid = (cur_pcid + 1))) {
              ...
              {
                double *cu_r_0 =
                    (cu_host_data + (cur_pcid * (6 * cu_cache_length)));
                ...
                long offset_len = (((pdimarr_cu)[0] *
                                    (((reduce_x) ? (0) : (ox)) +
                                     (((reduce_x) ? (1) : ((pdimarr_cu)[1])) *
                                      (((reduce_y) ? (0) : (oy)) +
                                       (((reduce_y) ? (1) : ((pdimarr_cu)[2])) *
                                        ((reduce_z) ? (0) : (oz))))))) +
                                   c_offset);
                    ...
                    for ((xyzy = 0); (xyzy < ylen); (xyzy = (xyzy + 1))) {
                      {
                        ...
                        for ((xyzx = 0); (xyzx < xlen); (xyzx = (xyzx + 1))) {
                          ...
                          long offset_len =
                              (((pdimarr_grid)[0] *
                                (((reduce_x) ? (0) : (ox)) +
                                 (((reduce_x) ? (1) : ((pdimarr_grid)[1])) *
                                  (((reduce_y) ? (0) : (oy)) +
                                   (((reduce_y) ? (1) : ((pdimarr_grid)[2])) *
                                    ((reduce_z) ? (0) : (oz))))))) +
                               g_offset);

                          int64_t offset_xyzlen =
                              (((reduce_dim == 1))
                                   ? (xyzx)
                                   : ((((reduce_dim == 2))
                                           ? (xyzy)
                          ...
                          GAPS_IO_FWrite(gid_grid, grid_r,
                                         (6 * (grid_xyzw)[0]));
                        }
                      }
                    }
      ...
      (g_offset =
           (g_offset + ((6 * ((use_non_uni_cache) ? ((pgcache)[i])
                                                  : (grid_one_cache_len))) +
                        1)));
      (c_offset =
           (c_offset + ((6 * ((use_non_uni_cache) ? ((pcucache)[i])
                                                  : (cu_one_cache_len))) +
                        1)));
    }
  }
...
int read_particle_parallel_file_for_mpi_fields_V0(
    Field3D_MPI *pthis, Gaps_IO_DataFile *gid_grid, Gaps_IO_DataFile *gid_cu,
    long *pgcache, long *pcucache, long numt, int reduce_dim, double r_x_rat,
    double r_y_rat, double r_z_rat, int use_non_uni_cache) {
...

          {
            ...
            for ((cur_pcid = 0); (cur_pcid < numvec);
...

              {
                ...
                ((cu_xyzw_0)[0] =
                     (num_load *
                      ((reduce_dim) ? ((pdimarr_grid)[reduce_dim]) : (1))));
                assert((num_load <= cu_cache_length));
                GAPS_IO_FRead(gid_cu, cu_r_0, (6 * (cu_xyzw_0)[0]));
                {
                  long g;

                  for ((g = 0); (g < ((reduce_dim) ? (num_load) : (0)));
                       (g = (g + 1))) {
                    ((cu_r_0)[(reduce_dim + (2 + (g * 6)))] =
                         (r_r_r * (cu_r_0)[(reduce_dim + (2 + (g * 6)))]));
                  }
                }
                {
                  long rd;
                    ...
                    for ((xyzy = 0); (xyzy < ylen); (xyzy = (xyzy + 1))) {
                      {
                        ...
                        for ((xyzx = 0); (xyzx < xlen); (xyzx = (xyzx + 1))) {
                          ...
                          GAPS_IO_FRead(gid_grid, grid_r, (6 * (grid_xyzw)[0]));
                          {
                            ...
                            for ((g = 0);
                                 (g < ((reduce_dim) ? (num_load) : (0)));
                                 (g = (g + 1))) {
                              ((grid_r)[((g * 6) + (reduce_dim + 2))] =
                                   (r_r_r *
                                    (grid_r)[(reduce_dim + (2 + (g * 6)))]));
                              ((grid_r)[((g * 6) + (reduce_dim + -1))] =
                                   ((grid_r)[((g * 6) + (reduce_dim + -1))] +
                                    offset_xyzlen));
                            }
                          }
...
int init_parallel_file_for_mpi_fields_V0(Field3D_MPI *pthis,
                                         Gaps_IO_DataFile *gid, char *pName,
                                         int64_t time_step) {
...
int init_parallel_file_for_mpi_fields(Field3D_MPI *pthis, Gaps_IO_DataFile *gid,
                                      char *pName, int64_t time_step,
  ...
  if ((version == 0)) {
    {
      ...
      void *blas_get_ITG_Potential_kernel =
          (data)->blas_get_ITG_Potential_kernel;
        ...
        if ((version == 2)) {
...

          {
            ...
            for ((i = 0); (i < num_runtime); (i = (i + 1))) {
              ...
              void **dm8x8_kernels = ((data + i))->dm8x8_kernels;

              void **geo_yeefdtd_kernels = ((data + i))->geo_yeefdtd_kernels;

              void **geo_yeefdtd_rect_kernels =
                  ((data + i))->geo_yeefdtd_rect_kernels;

              void **yeefdtd_stencil_kernels =
                  ((data + i))->yeefdtd_stencil_kernels;
              ...
              void *blas_yiszero_synced_kernel =
                  ((data + i))->blas_yiszero_synced_kernel;

              void *blas_mulxy_numele3_kernel =
                  ((data + i))->blas_mulxy_numele3_kernel;

              void *blas_yiszero_kernel = ((data + i))->blas_yiszero_kernel;

              void *blas_yiszero_full_block_kernel =
                  ((data + i))->blas_yiszero_full_block_kernel;

              void *blas_yisconst_kernel = ((data + i))->blas_yisconst_kernel;

              void *blas_yisconst_full_block_kernel =
                  ((data + i))->blas_yisconst_full_block_kernel;

              void *blas_get_ITG_Potential_kernel =
                  ((data + i))->blas_get_ITG_Potential_kernel;

              void *blas_get_ITG_Potential_full_block_kernel =
                  ((data + i))->blas_get_ITG_Potential_full_block_kernel;

              void *blas_invy_kernel = ((data + i))->blas_invy_kernel;

              void *blas_invy_full_block_kernel =
                  ((data + i))->blas_invy_full_block_kernel;

              void *blas_axpby_kernel = ((data + i))->blas_axpby_kernel;

              void *blas_axpby_full_block_kernel =
                  ((data + i))->blas_axpby_full_block_kernel;

              void *blas_axpy_kernel = ((data + i))->blas_axpy_kernel;

              void *blas_axpy_full_block_kernel =
                  ((data + i))->blas_axpy_full_block_kernel;

              void *blas_yisax_kernel = ((data + i))->blas_yisax_kernel;

              void *blas_yisax_full_block_kernel =
                  ((data + i))->blas_yisax_full_block_kernel;

              void *blas_mulxy_kernel = ((data + i))->blas_mulxy_kernel;

              void *blas_mulxy_full_block_kernel =
                  ((data + i))->blas_mulxy_full_block_kernel;

              void *blas_findmax_kernel = ((data + i))->blas_findmax_kernel;

              void *blas_findmax_full_block_kernel =
                  ((data + i))->blas_findmax_full_block_kernel;

              void *blas_dot_kernel = ((data + i))->blas_dot_kernel;

              void *blas_dot_full_block_kernel =
                  ((data + i))->blas_dot_full_block_kernel;

              void *blas_sum_kernel = ((data + i))->blas_sum_kernel;

              void *blas_sum_full_block_kernel =
                  ((data + i))->blas_sum_full_block_kernel;

              void *blas_yisax_shrink_kernel =
                  ((data + i))->blas_yisax_shrink_kernel;

              void *blas_yisax_enlarge_kernel =
                  ((data + i))->blas_yisax_enlarge_kernel;

              void *blas_axpy_shrink_kernel =
                  ((data + i))->blas_axpy_shrink_kernel;

              void *blas_axpy_enlarge_kernel =
                  ((data + i))->blas_axpy_enlarge_kernel;

              void *blas_axpby_shrink_kernel =
                  ((data + i))->blas_axpby_shrink_kernel;

              void *blas_axpby_enlarge_kernel =
                  ((data + i))->blas_axpby_enlarge_kernel;
...

          {
            ...
            for ((r = 0); (r < num_runtime); (r = (r + 1))) {
              ...
              long xblock = ((data + r))->xblock;

              long yblock = ((data + r))->yblock;

              long zblock = ((data + r))->zblock;
              ...
              long z_num_thread_block = ((data + r))->z_num_thread_block;

              int ovlp = ((data + r))->ovlp;

              int num_ele = ((data + r))->num_ele;

              int CD_type = ((data + r))->CD_type;

              void **sync_layer_pscmc = ((data + r))->sync_layer_pscmc;

              void **swap_layer_pscmc = ((data + r))->swap_layer_pscmc;

              void **sync_kernels = ((data + r))->sync_kernels;

              void **fdtd_kernels = ((data + r))->fdtd_kernels;

              void **dm_kernels = ((data + r))->dm_kernels;

              void **dmbihamt_kernels = ((data + r))->dmbihamt_kernels;

              void **dm8x8_kernels = ((data + r))->dm8x8_kernels;

              void **geo_yeefdtd_kernels = ((data + r))->geo_yeefdtd_kernels;

              void **geo_yeefdtd_rect_kernels =
                  ((data + r))->geo_yeefdtd_rect_kernels;

              void **yeefdtd_stencil_kernels =
                  ((data + r))->yeefdtd_stencil_kernels;

              void **hydroA_kernels = ((data + r))->hydroA_kernels;

              void **yee_abc_kernels = ((data + r))->yee_abc_kernels;

              void **yee_pec_kernels = ((data + r))->yee_pec_kernels;

              void **yee_damp_kernels = ((data + r))->yee_damp_kernels;

              void **yee_setfix_kernels = ((data + r))->yee_setfix_kernels;

              void *rdcd = ((data + r))->rdcd;

              double *rdcd_host = ((data + r))->rdcd_host;

              void *cur_rankx_pscmc = ((data + r))->cur_rankx_pscmc;

              void *cur_ranky_pscmc = ((data + r))->cur_ranky_pscmc;

              void *cur_rankz_pscmc = ((data + r))->cur_rankz_pscmc;

              void *xoffset = ((data + r))->xoffset;

              void *yoffset = ((data + r))->yoffset;

              void *zoffset = ((data + r))->zoffset;
              ...
              long *global_id = ((data + r))->global_id;

              long global_pid = ((data + r))->global_pid;

              long *adj_ids = ((data + r))->adj_ids;

              long *adj_processes = ((data + r))->adj_processes;

              long *adj_local_tid = ((data + r))->adj_local_tid;

              void *main_data = ((data + r))->main_data;

              double delta_x = ((data + r))->delta_x;

              double delta_y = ((data + r))->delta_y;

              double delta_z = ((data + r))->delta_z;

              void *blas_yiszero_synced_kernel =
                  ((data + r))->blas_yiszero_synced_kernel;

              void *blas_mulxy_numele3_kernel =
                  ((data + r))->blas_mulxy_numele3_kernel;

              void *blas_yiszero_kernel = ((data + r))->blas_yiszero_kernel;

              void *blas_yiszero_full_block_kernel =
                  ((data + r))->blas_yiszero_full_block_kernel;

              void *blas_yisconst_kernel = ((data + r))->blas_yisconst_kernel;

              void *blas_yisconst_full_block_kernel =
                  ((data + r))->blas_yisconst_full_block_kernel;

              void *blas_get_ITG_Potential_kernel =
                  ((data + r))->blas_get_ITG_Potential_kernel;

              void *blas_get_ITG_Potential_full_block_kernel =
                  ((data + r))->blas_get_ITG_Potential_full_block_kernel;

              void *blas_invy_kernel = ((data + r))->blas_invy_kernel;

              void *blas_invy_full_block_kernel =
                  ((data + r))->blas_invy_full_block_kernel;

              void *blas_axpby_kernel = ((data + r))->blas_axpby_kernel;

              void *blas_axpby_full_block_kernel =
                  ((data + r))->blas_axpby_full_block_kernel;

              void *blas_axpy_kernel = ((data + r))->blas_axpy_kernel;

              void *blas_axpy_full_block_kernel =
                  ((data + r))->blas_axpy_full_block_kernel;

              void *blas_yisax_kernel = ((data + r))->blas_yisax_kernel;

              void *blas_yisax_full_block_kernel =
                  ((data + r))->blas_yisax_full_block_kernel;

              void *blas_mulxy_kernel = ((data + r))->blas_mulxy_kernel;

              void *blas_mulxy_full_block_kernel =
                  ((data + r))->blas_mulxy_full_block_kernel;

              void *blas_findmax_kernel = ((data + r))->blas_findmax_kernel;

              void *blas_findmax_full_block_kernel =
                  ((data + r))->blas_findmax_full_block_kernel;

              void *blas_dot_kernel = ((data + r))->blas_dot_kernel;

              void *blas_dot_full_block_kernel =
                  ((data + r))->blas_dot_full_block_kernel;

              void *blas_sum_kernel = ((data + r))->blas_sum_kernel;

              void *blas_sum_full_block_kernel =
                  ((data + r))->blas_sum_full_block_kernel;

              void *blas_yisax_shrink_kernel =
                  ((data + r))->blas_yisax_shrink_kernel;

              void *blas_yisax_enlarge_kernel =
                  ((data + r))->blas_yisax_enlarge_kernel;

              void *blas_axpy_shrink_kernel =
                  ((data + r))->blas_axpy_shrink_kernel;

              void *blas_axpy_enlarge_kernel =
                  ((data + r))->blas_axpy_enlarge_kernel;

              void *blas_axpby_shrink_kernel =
                  ((data + r))->blas_axpby_shrink_kernel;

              void *blas_axpby_enlarge_kernel =
                  ((data + r))->blas_axpby_enlarge_kernel;
                ...
                for ((i = 0); (i < numvec); (i = (i + 1))) {
                  ((plocations)[(i + numvec_offset)] =
                       (((global_x_offset)[i] / xlen) +
                        (x_num_thread_block *
                         (((global_y_offset)[i] / ylen) +
                          (y_num_thread_block *
                           ((global_z_offset)[i] / zlen))))));
                }
              }
              (numvec_offset = (numvec_offset + numvec));
            }
          }
          GAPS_IO_InitDataInfoV2(gid, "", GAPS_IO_FLOAT64, 4, pdimarr, pblkarr,
                                 plocations, numvec_total, 0);
          if (num_reduce_proc) {
...
int read_parallel_file_for_mpi_fields(Field3D_MPI *pthis, Gaps_IO_DataFile *gid,
                                      int64_t timestep) {
  ...
  for (i = 0; (i < num_runtime); i++) {
    ...
    void **yeefdtd_stencil_kernels = ((data + i))->yeefdtd_stencil_kernels;
    ...
    void *blas_dot_full_block_kernel = ((data + i))->blas_dot_full_block_kernel;

    void *blas_sum_kernel = ((data + i))->blas_sum_kernel;

    void *blas_sum_full_block_kernel = ((data + i))->blas_sum_full_block_kernel;

    void *blas_yisax_shrink_kernel = ((data + i))->blas_yisax_shrink_kernel;

    void *blas_yisax_enlarge_kernel = ((data + i))->blas_yisax_enlarge_kernel;

    void *blas_axpy_shrink_kernel = ((data + i))->blas_axpy_shrink_kernel;

    void *blas_axpy_enlarge_kernel = ((data + i))->blas_axpy_enlarge_kernel;

    void *blas_axpby_shrink_kernel = ((data + i))->blas_axpby_shrink_kernel;

    void *blas_axpby_enlarge_kernel = ((data + i))->blas_axpby_enlarge_kernel;
    ...
    for (vid = 0; (vid < numvec); vid++) {
      if (((gid)->version == 0)) {
        ...
        int64_t offsetlen =
            (realoneblklen * ((((gid)->version == 1))
                                  ? ((((global_x_offset)[vid] / xlen) +
                                      (x_num_thread_block *
                                       (((global_y_offset)[vid] / ylen) +
                                        (y_num_thread_block *
                                         ((global_z_offset)[vid] / zlen))))))
                                  : (vid)));
...
int write_parallel_file_for_mpi_fields(Field3D_MPI *pthis,
  ...
  for (i = 0; (i < num_runtime); i++) {
    ...
    if (((gid)->version == 2)) {
      if (((cur_rank != (gid)->send_to_proc) && (gid)->num_reduce_proc)) {
        MPI_Send(&(numvec), 1, PS_MPI_LONG, (gid)->send_to_proc, cur_rank,
                 PS_MPI_COMM_WORLD);
      ...
      if (((gid)->version == 0)) {
        ...
        if ((((gid)->version == 2) && (gid)->num_reduce_proc)) {
          ...
          if (((gid)->cur_rank != (gid)->send_to_proc)) {
            PS_MPI_Send(write_buffer, realoneblklen, PS_MPI_DOUBLE,
                        (gid)->send_to_proc, cur_rank, PS_MPI_COMM_WORLD);
      ...
      if (((gid)->cur_rank != (gid)->send_to_proc)) {
      ...
      } else {
        {
...

          {
            ...
            for ((n = (cur_rank + 1));
                 (n < (num_reduce_proc * (real_rank + 1))); (n = (n + 1))) {
              int num_proc;
              ...
              PS_MPI_Recv(&(remote_numvec), 1, PS_MPI_LONG, n, n,
                          PS_MPI_COMM_WORLD, &(s1));
              {
                long g;

                for ((g = 0); (g < remote_numvec); (g = (g + 1))) {
                  PS_MPI_Recv(write_buffer, realoneblklen, PS_MPI_DOUBLE, n, n,
                              PS_MPI_COMM_WORLD, &(s1));
                  GAPS_IO_FWrite(gid, write_buffer, realoneblklen);
                }
              }
...
int mpi_field_write_to_file(Field3D_MPI *pthis, Gaps_IO_DataFile *pgid,
                            long num_timestep) {
