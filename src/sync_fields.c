...
#ifdef SYMPIC_CUDA
      cuda_pscmc_get_h_data((sync_layer_pscmc)[0], (void**)(&sync_mem_host));
#elif defined(SYMPIC_MAPU)
      mapu_pscmc_get_h_data((sync_layer_pscmc)[0], (void**)(&sync_mem_host));
#endif
...
#elif  defined(SYMPIC_MAPU)
        mapu_pscmc_mem_sync_d2h((sync_layer_pscmc)[0]);
#endif
      }
...
#ifdef SYMPIC_CUDA
      cuda_pscmc_get_h_data((sync_layer_pscmc)[0], (void**)(&sync_mem_host));
      cuda_pscmc_get_h_data((swap_layer_pscmc)[0], (void**)(&swap_mem_host));
#elif defined(SYMPIC_MAPU)
      mapu_pscmc_get_h_data((sync_layer_pscmc)[0], (void**)(&sync_mem_host));
      mapu_pscmc_get_h_data((swap_layer_pscmc)[0], (void**)(&swap_mem_host));
#endif
...
#elif defined(SYMPIC_MAPU)
    mapu_pscmc_mem_sync_h2d((swap_layer_pscmc)[0]);
#endif    
