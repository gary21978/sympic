...
void c_RECT_YEE_CURL_L_scmc_kernel(double *inoutE1, double *inB0, int *xoffset,
                                   ...
                                   double DELTA_Z, long scmc_internal_g_idy,
                 ...
                 (pow(DELTA_X, -1) *
                  (DELTA_Y *
                   (pow(DELTA_Z, -1) *
                    ((-1.00000000000000000e+00 *
                      (DELTA_X *
                       (pow(DELTA_Y, -1) * (pow(DELTA_Z, -1) * vB00111)))) +
                     ((DELTA_X *
                       (pow(DELTA_Y, -1) * (pow(DELTA_Z, -1) * vB01111))) +
                      ((pow(DELTA_X, -1) *
                        (pow(DELTA_Y, -1) * (DELTA_Z * vB21101))) +
                       (-1.00000000000000000e+00 *
                        (pow(DELTA_X, -1) *
               ...
               (((inoutE1 + blk_offset))[(
                ...
                (DT * (pow(DELTA_X, -1) *
                       (pow(DELTA_Y, -1) *
                        (DELTA_Z *
                         ((DELTA_X *
                           (pow(DELTA_Y, -1) * (pow(DELTA_Z, -1) * vB01011))) +
                          ((-1.00000000000000000e+00 *
                            (DELTA_X * (pow(DELTA_Y, -1) *
                                        (pow(DELTA_Z, -1) * vB01111)))) +
                           ((-1.00000000000000000e+00 *
