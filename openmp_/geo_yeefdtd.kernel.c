...

{
 ...
 ;
	...
	if (  	(  0 && 	(  	(  blk_all_len_nonele * num_ele )
 < 2048 )
 )
  ){  
...
] + 	(  DT * 	(  x0 * 	(  	pow ( 	(  1.00000000000000000e+00 + 	(  x0 + xo0 )
 )
 , -1 )
 ...
 * vB10111 )
 ...
 + 	(  	(  -1.00000000000000000e+00 * 	(  	pow ( x0 , -1 )
 * 	(  	(  1.00000000000000000e+00 + 	(  x0 + xo0 )
 )
 * 	(  	pow ( DELTA_X , -1 )
 * 	(  DELTA_Y * 	(  	pow ( DELTA_Z , -1 )
 * vB11111 )
 ...
 + 	(  	(  -1.00000000000000000e+00 * 	(  x0 * 	(  	pow ( 	(  1.00000000000000000e+00 + 	(  x0 + xo0 )
 )
 , -1 )
 * 	(  	pow ( DELTA_X , -1 )
 * 	(  	pow ( DELTA_Y , -1 )
 * 	(  DELTA_Z * vB21011 )
 ...
 + 	(  x0 * 	(  	pow ( 	(  1.00000000000000000e+00 + 	(  x0 + xo0 )
 )
 , -1 )
 * 	(  	pow ( DELTA_X , -1 )
 * 	(  	pow ( DELTA_Y , -1 )
 ...
 * 	(  	pow ( DELTA_X , -1 )
 * 	(  	pow ( DELTA_Y , -1 )
 * 	(  DELTA_Z * 	(  	(  x0 * 	(  	pow ( 	(  1.00000000000000000e+00 + 	(  x0 + xo0 )
 )
 , -1 )
 * 	(  DELTA_X * 	(  	pow ( DELTA_Y , -1 )
 * 	(  	pow ( DELTA_Z , -1 )
...
void  openmp_YEE_CURL_R_scmc_kernel (double *  inoutE1 ,double *  inB0 ,int *  xoffset ,int *  yoffset ,int *  zoffset ,long  y_cpu_core ,long  numvec ,long  XLEN ,long  YLEN ,long  ZLEN ,int  ovlp ,long  xblock ,long  yblock ,long  zblock ,int  num_ele ,double  DT ,long  scmc_internal_g_idy ,long  scmc_internal_g_ylen ){
	const long  pscmc_compute_unit_id = 	omp_get_thread_num (  )
 ;
