...
int GAPS_IO_InitDataInfoV2(Gaps_IO_DataFile *pOutfile, char *Prefix, int64_t Type, int64_t Dim, int64_t *pDimarray,
                           int64_t *pBlockarray, int64_t *pLocationarray, int64_t Num_block_current_proc,
                           int64_t time_step_current) {
...
int GAPS_IO_InitDataInfoV1(Gaps_IO_DataFile *pOutfile, int64_t Type, int64_t Dim, int64_t *pDimarray,
                           int64_t *pBlockarray) {
  ((pOutfile)->dim = Dim);
...
int GAPS_IO_DataSeek(Gaps_IO_DataFile *pthis, int64_t Step, int64_t Offset) {
  ...
  int send_to_proc = (pthis)->send_to_proc;
  long ret =
      ((((version < 2) || ((cur_rank == send_to_proc) || (!num_reduce_proc))))
           ? ((((version >= 2))
                   ? (fseek(pfile,
                            (((GAPS_IO_GlobalTypeLen)[type] *
                              (Offset + (Step * (((version < 2)) ? (numperstep)
                                                                 : ((((num_reduce_proc) ? (num_block_all_reduce_group)
                                                                                        : (num_block_current_proc)) *
                                                                     block_len)))))) +
                             (sizeof(int64_t) * (3 + ((((version == 0)) ? (1) : (2)) * dim)))),
                            SEEK_SET))
                   : (MPI_File_seek(
                         (((MPI_File *)pfile))[0],
                         (((GAPS_IO_GlobalTypeLen)[type] *
...
int GAPS_IO_InitOFile_with_TimeStepV2_withrank(Gaps_IO_DataFile *pthis, char *pName, char *pNamePrefix,
                                               int64_t timestep, long rank) {
  int64_t version = (pthis)->version;
  int64_t type = (pthis)->type;
  int64_t dim = (pthis)->dim;
  ...
  if ((version > 1)) {
    ...
    if ((ret > (max_len - 2))) {
      fprintf(stderr, "rank %ld Error: Maximum length of one file is 510\n", rank);
      assert(0);
    } else {
      0;
    }
      ...
      if (((version < 2) || ((cur_rank == send_to_proc) || (!num_reduce_proc)))) {
        assert((1 == (((version >= 2)) ? (fwrite(&(version), sizeof(int64_t), 1, pfile)) : (({
                  MPI_Datatype mdt =
                      (((sizeof(int64_t) == 1))
                           ...
                           : ((((sizeof(int64_t) == 2))
                                   ? (MPI_SHORT)
                                   : ((((sizeof(int64_t) == 4)) ? (MPI_INT)
                                                                : ((((sizeof(int64_t) == 8)) ? (MPI_LONG_LONG) : (({
                  ...
                  for (0; (cur_rd < cnt); (cur_rd = (cur_rd + 134217728))) {
                    ...
                    MPI_File_write((((MPI_File *)pfile))[0], (((void *)&(version)) + (cur_rd * sizeof(int64_t))),
                                   mpi_rdd, mdt, &(stat));
        ...
        assert((1 == (((version >= 2)) ? (fwrite(&(type), sizeof(int64_t), 1, pfile)) : (({
                  ...
                  for (0; (cur_rd < cnt); (cur_rd = (cur_rd + 134217728))) {
                    ...
                    MPI_File_write((((MPI_File *)pfile))[0], (((void *)&(type)) + (cur_rd * sizeof(int64_t))), mpi_rdd,
                                   mdt, &(stat));
                    MPI_Get_count(&(stat), mdt, &(mpi_rdd));
                    (readed = (readed + mpi_rdd));
                  }
        ...
        assert((1 == (((version >= 2)) ? (fwrite(&(dim), sizeof(int64_t), 1, pfile)) : (({
                  ...
                  for (0; (cur_rd < cnt); (cur_rd = (cur_rd + 134217728))) {
                    ...
                    MPI_File_write((((MPI_File *)pfile))[0], (((void *)&(dim)) + (cur_rd * sizeof(int64_t))), mpi_rdd,
                                   mdt, &(stat));
                    MPI_Get_count(&(stat), mdt, &(mpi_rdd));
                    (readed = (readed + mpi_rdd));
                  }
        ...
        assert((dim == (((version >= 2)) ? (fwrite(pdimarray, sizeof(int64_t), dim, pfile)) : (({
                  ...
                  for (0; (cur_rd < cnt); (cur_rd = (cur_rd + 134217728))) {
                    ...
                    MPI_File_write((((MPI_File *)pfile))[0], (((void *)pdimarray) + (cur_rd * sizeof(int64_t))),
                                   mpi_rdd, mdt, &(stat));
                    MPI_Get_count(&(stat), mdt, &(mpi_rdd));
                    (readed = (readed + mpi_rdd));
                  }
        ...
        if ((version >= 1)) {
          assert((dim == (((version >= 2)) ? (fwrite(pblockarray, sizeof(int64_t), dim, pfile)) : (({
                    ...
                    for (0; (cur_rd < cnt); (cur_rd = (cur_rd + 134217728))) {
                      ...
                      MPI_File_write((((MPI_File *)pfile))[0], (((void *)pblockarray) + (cur_rd * sizeof(int64_t))),
                                     mpi_rdd, mdt, &(stat));
                      MPI_Get_count(&(stat), mdt, &(mpi_rdd));
                      (readed = (readed + mpi_rdd));
                    }
...
int GAPS_IO_InitIFilePointer(Gaps_IO_DataFile *pthis, FILE *fp) {
  ...
  ((pthis)->pfile = pfile);
  assert(
      (1 == (((version >= 2)) ? (fread(&(version), sizeof(int64_t), 1, pfile)) : (({
         MPI_Datatype mdt =
             (((sizeof(int64_t) == 1))
                  ? (MPI_CHAR)
                  : ((((sizeof(int64_t) == 2))
  ...
  assert(
      (1 == (((version >= 2)) ? (fread(&(type), sizeof(int64_t), 1, pfile)) : (({
         MPI_Datatype mdt =
             (((sizeof(int64_t) == 1))
                  ? (MPI_CHAR)
                  : ((((sizeof(int64_t) == 2))
  ...
  ((pthis)->type = type);
  assert(
      (1 == (((version >= 2)) ? (fread(&(dim), sizeof(int64_t), 1, pfile)) : (({
         MPI_Datatype mdt =
             (((sizeof(int64_t) == 1))
                  ? (MPI_CHAR)
                  : ((((sizeof(int64_t) == 2))
  ...
  assert(pblockarray);
  assert(
      (dim == (((version >= 2)) ? (fread(pdimarray, sizeof(int64_t), dim, pfile)) : (({
         MPI_Datatype mdt =
             (((sizeof(int64_t) == 1))
                  ? (MPI_CHAR)
                  : ((((sizeof(int64_t) == 2))
  ...
  if ((version >= 1)) {
    assert((
        dim == (((version >= 2)) ? (fread(pblockarray, sizeof(int64_t), dim, pfile)) : (({
          MPI_Datatype mdt =
              (((sizeof(int64_t) == 1))
                   ? (MPI_CHAR)
                   : ((((sizeof(int64_t) == 2))
...
int GAPS_IO_FRead(Gaps_IO_DataFile *pthis, void *pData, int64_t NumData) {
  ...
  if ((NumData < 0)) {
    (NumData = (((version < 2))
                    ? (numperstep)
                    : ((((num_reduce_proc) ? (num_block_all_reduce_group) : (num_block_current_proc)) * block_len))));
  } else {
    0;
  }
  return (((version >= 2)) ? (fread(pData, (GAPS_IO_GlobalTypeLen)[type], NumData, pfile)) : (({
    MPI_Datatype mdt =
        ((((GAPS_IO_GlobalTypeLen)[type] == 1))
             ? (MPI_CHAR)
             : (((((GAPS_IO_GlobalTypeLen)[type] == 2))
                     ? (MPI_SHORT)
                     : (((((GAPS_IO_GlobalTypeLen)[type] == 4))
                             ? (MPI_INT)
...
int64_t GAPS_IO_FWrite(Gaps_IO_DataFile *pthis, void *pData, int64_t NumData) {
  ...
  return ((((version < 2) || ((cur_rank == send_to_proc) || (!num_reduce_proc))))
              ? ((((version >= 2)) ? (fwrite(pData, (GAPS_IO_GlobalTypeLen)[type], NumData, pfile)) : (({
                  MPI_Datatype mdt =
                      ((((GAPS_IO_GlobalTypeLen)[type] == 1))
                           ? (MPI_CHAR)
                           : (((((GAPS_IO_GlobalTypeLen)[type] == 2))
                  ...
                  for (0; (cur_rd < cnt); (cur_rd = (cur_rd + 134217728))) {
                    ...
                    MPI_File_write((((MPI_File *)pfile))[0],
                                   (((void *)pData) + (cur_rd * (GAPS_IO_GlobalTypeLen)[type])), mpi_rdd, mdt, &(stat));
                    MPI_Get_count(&(stat), mdt, &(mpi_rdd));
                    (readed = (readed + mpi_rdd));
                  }
                  readed;
...
int GAPS_IO_DataNumStepsAndResidue(Gaps_IO_DataFile *pthis, int64_t *pNumsteps, int64_t *pResidue) {
  ...
  (end_pos = ((end_pos - ((((((version == 0)) ? (1) : (2)) * dim) + 3) * (GAPS_IO_GlobalTypeLen)[type])) /
              (GAPS_IO_GlobalTypeLen)[type]));
  ((pNumsteps)[0] =
       (end_pos / (((version < 2)) ? (numperstep)
                                   : ((((num_reduce_proc) ? (num_block_all_reduce_group) : (num_block_current_proc)) *
                                       block_len)))));
  ((pResidue)[0] =
       (end_pos % (((version < 2)) ? (numperstep)
                                   : ((((num_reduce_proc) ? (num_block_all_reduce_group) : (num_block_current_proc)) *
...
int GAPS_IO_TruncateFile(Gaps_IO_DataFile *pthis, int64_t NumSteps, int64_t NumData) {
  ...
  return ((((version < 2) || ((cur_rank == send_to_proc) || (!num_reduce_proc))))
              ? ((((version >= 2))
                      ? (ftruncate(fileno(pfile), ((NumSteps * (NumData * (GAPS_IO_GlobalTypeLen)[type])) +
                                                   (sizeof(int64_t) * (3 + ((((version == 0)) ? (1) : (2)) * dim))))))
                      : ((((version <= 1))
                              ? (MPI_File_set_size((((MPI_File *)pfile))[0],
                                                   ((NumSteps * (NumData * (GAPS_IO_GlobalTypeLen)[type])) +
                                                    (sizeof(int64_t) * (3 + ((((version == 0)) ? (1) : (2)) * dim))))))
                              : (ftruncate(fileno(pfile),
                                           ((NumSteps * (NumData * (GAPS_IO_GlobalTypeLen)[type])) +
                                            (sizeof(int64_t) * (3 + ((((version == 0)) ? (1) : (2)) * dim))))))))))
              : (0));
}
