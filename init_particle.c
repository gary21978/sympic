...
void user_defined_particle_distribution(double *xyzvx, long xyzx, long xyzy,
                                        long xyzz, int cur_sp, long l,
...
int init_particle(One_Particle_Collection *pthis, Field3D_Seq *pfield,
                  double Mass, double Charge, double Number_particle_per_marker,
  ...
  ((pthis)->cu_cache_length = cu_cache_length);
  {
    ...
    ((pthis)->inoutput =
         malloc((((0 == CD_type))
                     ? (sizeof(c_pscmc_mem))
                     : ((((1 == CD_type))
                             ? (sizeof(openmp_pscmc_mem))
                             : ((((2 == CD_type)) ? (sizeof(cuda_pscmc_mem))
                                                  : (0))))))));
    ((pthis)->xyzw =
         malloc((((0 == CD_type))
                     ? (sizeof(c_pscmc_mem))
    ...
    ((pthis)->adjoint_vec_pids =
         malloc((((0 == CD_type))
                     ...
                     : ((((1 == CD_type))
                             ...
                             : ((((2 == CD_type)) ? (sizeof(cuda_pscmc_mem))
                                                  : (0))))))));
    // NOTE: Standard CUDA regression does not use *_nopush_par* variants.
    {
      size_t structlen;

      if ((0 == CD_type)) {
        c_ngeo_gc_get_struct_len(&(structlen));

      } else {
        if ((1 == CD_type)) {
          openmp_ngeo_gc_get_struct_len(&(structlen));

        } else {
          if ((2 == CD_type)) {
            cuda_ngeo_gc_get_struct_len(&(structlen));
      ...
      (((pthis)->nonrel_test_kernel)[17] = malloc(structlen));
      if ((0 == CD_type)) {
        c_ngeo_gc_init(pe, ((pthis)->nonrel_test_kernel)[17]);

      } else {
        if ((1 == CD_type)) {
          openmp_ngeo_gc_init(pe, ((pthis)->nonrel_test_kernel)[17]);

        } else {
          if ((2 == CD_type)) {
            cuda_ngeo_gc_init(pe, ((pthis)->nonrel_test_kernel)[17]);
    ...
    }
    {
      ...
      if ((0 == CD_type)) {
        c_geo_nr_Bfield_pushJ_vlo_get_struct_len(&(structlen));

      } else {
        if ((1 == CD_type)) {
          openmp_geo_nr_Bfield_pushJ_vlo_get_struct_len(&(structlen));
      ...
      (((pthis)->nonrel_test_kernel)[16] = malloc(structlen));
      if ((0 == CD_type)) {
        c_geo_nr_Bfield_pushJ_vlo_init(pe, ((pthis)->nonrel_test_kernel)[16]);

      } else {
        if ((1 == CD_type)) {
          openmp_geo_nr_Bfield_pushJ_vlo_init(
              pe, ((pthis)->nonrel_test_kernel)[16]);

        } else {
          if ((2 == CD_type)) {
            cuda_geo_nr_Bfield_pushJ_vlo_init(
                pe, ((pthis)->nonrel_test_kernel)[16]);
    ...
    }
    {
      ...
      if ((0 == CD_type)) {
        c_geo_nr_vlo_get_struct_len(&(structlen));

      } else {
        if ((1 == CD_type)) {
          openmp_geo_nr_vlo_get_struct_len(&(structlen));

        } else {
          if ((2 == CD_type)) {
            cuda_geo_nr_vlo_get_struct_len(&(structlen));
      ...
      (((pthis)->nonrel_test_kernel)[14] = malloc(structlen));
      if ((0 == CD_type)) {
        c_geo_nr_vlo_init(pe, ((pthis)->nonrel_test_kernel)[14]);

      } else {
        if ((1 == CD_type)) {
          openmp_geo_nr_vlo_init(pe, ((pthis)->nonrel_test_kernel)[14]);

        } else {
          if ((2 == CD_type)) {
            cuda_geo_nr_vlo_init(pe, ((pthis)->nonrel_test_kernel)[14]);
    ...
    }
    {
      ...
      if ((0 == CD_type)) {
        c_geo_nr_get_struct_len(&(structlen));

      } else {
        if ((1 == CD_type)) {
          openmp_geo_nr_get_struct_len(&(structlen));

        } else {
          if ((2 == CD_type)) {
            cuda_geo_nr_get_struct_len(&(structlen));
      ...
      (((pthis)->nonrel_test_kernel)[13] = malloc(structlen));
      if ((0 == CD_type)) {
        c_geo_nr_init(pe, ((pthis)->nonrel_test_kernel)[13]);

      } else {
        if ((1 == CD_type)) {
          openmp_geo_nr_init(pe, ((pthis)->nonrel_test_kernel)[13]);

        } else {
          if ((2 == CD_type)) {
            cuda_geo_nr_init(pe, ((pthis)->nonrel_test_kernel)[13]);
    ...
    ((pthis)->cu_swap_l_6_kernel = malloc(
         (((0 == CD_type))
              ? (sizeof(c_cu_swap_l_6_struct))
              : ((((1 == CD_type))
                      ? (sizeof(openmp_cu_swap_l_6_struct))
                      : ((((2 == CD_type)) ? (sizeof(cuda_cu_swap_l_6_struct))
                                           : (0))))))));
    if ((0 == CD_type)) {
      c_cu_swap_l_6_init(pe, (pthis)->cu_swap_l_6_kernel);

    } else {
      if ((1 == CD_type)) {
        openmp_cu_swap_l_6_init(pe, (pthis)->cu_swap_l_6_kernel);
    ...
    ((pthis)->cu_swap_r_6_kernel = malloc(
         (((0 == CD_type))
              ? (sizeof(c_cu_swap_r_6_struct))
              : ((((1 == CD_type))
                      ? (sizeof(openmp_cu_swap_r_6_struct))
                      : ((((2 == CD_type)) ? (sizeof(cuda_cu_swap_r_6_struct))
                                           : (0))))))));
    if ((0 == CD_type)) {
      c_cu_swap_r_6_init(pe, (pthis)->cu_swap_r_6_kernel);

    } else {
      if ((1 == CD_type)) {
        openmp_cu_swap_r_6_init(pe, (pthis)->cu_swap_r_6_kernel);
    ...
    ((pthis)->move_back_kernel_6_kernel =
         malloc((((0 == CD_type))
                     ? (sizeof(c_move_back_kernel_6_struct))
                     : ((((1 == CD_type))
                             ? (sizeof(openmp_move_back_kernel_6_struct))
                             : ((((2 == CD_type))
                                     ? (sizeof(cuda_move_back_kernel_6_struct))
                                     : (0))))))));
    if ((0 == CD_type)) {
      c_move_back_kernel_6_init(pe, (pthis)->move_back_kernel_6_kernel);

    } else {
      if ((1 == CD_type)) {
        openmp_move_back_kernel_6_init(pe, (pthis)->move_back_kernel_6_kernel);
    ...
    ((pthis)->cu_swap_l_8_kernel = malloc(
         (((0 == CD_type))
              ? (sizeof(c_cu_swap_l_8_struct))
              : ((((1 == CD_type))
                      ? (sizeof(openmp_cu_swap_l_8_struct))
                      : ((((2 == CD_type)) ? (sizeof(cuda_cu_swap_l_8_struct))
                                           : (0))))))));
    if ((0 == CD_type)) {
      c_cu_swap_l_8_init(pe, (pthis)->cu_swap_l_8_kernel);

    } else {
      if ((1 == CD_type)) {
        openmp_cu_swap_l_8_init(pe, (pthis)->cu_swap_l_8_kernel);
    ...
    ((pthis)->cu_swap_r_8_kernel = malloc(
         (((0 == CD_type))
              ? (sizeof(c_cu_swap_r_8_struct))
              : ((((1 == CD_type))
                      ? (sizeof(openmp_cu_swap_r_8_struct))
                      : ((((2 == CD_type)) ? (sizeof(cuda_cu_swap_r_8_struct))
                                           : (0))))))));
    if ((0 == CD_type)) {
      c_cu_swap_r_8_init(pe, (pthis)->cu_swap_r_8_kernel);

    } else {
      if ((1 == CD_type)) {
        openmp_cu_swap_r_8_init(pe, (pthis)->cu_swap_r_8_kernel);
    ...
    ((pthis)->move_back_kernel_8_kernel =
         malloc((((0 == CD_type))
                     ? (sizeof(c_move_back_kernel_8_struct))
                     : ((((1 == CD_type))
                             ? (sizeof(openmp_move_back_kernel_8_struct))
                             : ((((2 == CD_type))
                                     ? (sizeof(cuda_move_back_kernel_8_struct))
                                     : (0))))))));
    if ((0 == CD_type)) {
      c_move_back_kernel_8_init(pe, (pthis)->move_back_kernel_8_kernel);

    } else {
      if ((1 == CD_type)) {
        openmp_move_back_kernel_8_init(pe, (pthis)->move_back_kernel_8_kernel);
    ...
    ((pthis)->dump_ene_num_kernel = malloc(
         (((0 == CD_type))
              ? (sizeof(c_dump_ene_num_struct))
              : ((((1 == CD_type))
                      ? (sizeof(openmp_dump_ene_num_struct))
                      : ((((2 == CD_type)) ? (sizeof(cuda_dump_ene_num_struct))
                                           : (0))))))));
    if ((0 == CD_type)) {
    ...
    ((sort_kernel)[0] = malloc(
         (((0 == CD_type))
              ? (sizeof(c_gpu_sort_one_grid_x_6_struct))
              : ((((1 == CD_type))
                      ? (sizeof(openmp_gpu_sort_one_grid_x_6_struct))
                      : ((((2 == CD_type))
                              ? (sizeof(cuda_gpu_sort_one_grid_x_6_struct))
                              : (0))))))));
    ((sort_kernel)[1] =
         malloc((((0 == CD_type))
                     ? (sizeof(c_sort_one_grid_x_6_struct))
                     : ((((1 == CD_type))
                             ? (sizeof(openmp_sort_one_grid_x_6_struct))
                             : ((((2 == CD_type))
                                     ? (sizeof(cuda_sort_one_grid_x_6_struct))
                                     : (0))))))));
    if ((0 == CD_type)) {
      c_gpu_sort_one_grid_x_6_init(pe, (sort_kernel)[0]);

    } else {
      if ((1 == CD_type)) {
        openmp_gpu_sort_one_grid_x_6_init(pe, (sort_kernel)[0]);
    ...
    if ((0 == CD_type)) {
      c_sort_one_grid_x_6_init(pe, (sort_kernel)[1]);

    } else {
      if ((1 == CD_type)) {
        openmp_sort_one_grid_x_6_init(pe, (sort_kernel)[1]);
    ...
    ((sort_kernel)[2] = malloc(
         (((0 == CD_type))
              ? (sizeof(c_gpu_sort_one_grid_y_6_struct))
              : ((((1 == CD_type))
                      ? (sizeof(openmp_gpu_sort_one_grid_y_6_struct))
                      : ((((2 == CD_type))
                              ? (sizeof(cuda_gpu_sort_one_grid_y_6_struct))
                              : (0))))))));
    ((sort_kernel)[3] =
         malloc((((0 == CD_type))
                     ? (sizeof(c_sort_one_grid_y_6_struct))
                     : ((((1 == CD_type))
                             ? (sizeof(openmp_sort_one_grid_y_6_struct))
                             : ((((2 == CD_type))
                                     ? (sizeof(cuda_sort_one_grid_y_6_struct))
                                     : (0))))))));
    if ((0 == CD_type)) {
      c_gpu_sort_one_grid_y_6_init(pe, (sort_kernel)[2]);

    } else {
      if ((1 == CD_type)) {
        openmp_gpu_sort_one_grid_y_6_init(pe, (sort_kernel)[2]);
    ...
    if ((0 == CD_type)) {
      c_sort_one_grid_y_6_init(pe, (sort_kernel)[3]);

    } else {
      if ((1 == CD_type)) {
        openmp_sort_one_grid_y_6_init(pe, (sort_kernel)[3]);
    ...
    ((sort_kernel)[4] = malloc(
         (((0 == CD_type))
              ? (sizeof(c_gpu_sort_one_grid_z_6_struct))
              : ((((1 == CD_type))
                      ? (sizeof(openmp_gpu_sort_one_grid_z_6_struct))
                      : ((((2 == CD_type))
                              ? (sizeof(cuda_gpu_sort_one_grid_z_6_struct))
                              : (0))))))));
    ((sort_kernel)[5] =
         malloc((((0 == CD_type))
                     ? (sizeof(c_sort_one_grid_z_6_struct))
                     : ((((1 == CD_type))
                             ? (sizeof(openmp_sort_one_grid_z_6_struct))
                             : ((((2 == CD_type))
                                     ? (sizeof(cuda_sort_one_grid_z_6_struct))
                                     : (0))))))));
    if ((0 == CD_type)) {
      c_gpu_sort_one_grid_z_6_init(pe, (sort_kernel)[4]);

    } else {
      if ((1 == CD_type)) {
        openmp_gpu_sort_one_grid_z_6_init(pe, (sort_kernel)[4]);
    ...
    if ((0 == CD_type)) {
      c_sort_one_grid_z_6_init(pe, (sort_kernel)[5]);

    } else {
      if ((1 == CD_type)) {
        openmp_sort_one_grid_z_6_init(pe, (sort_kernel)[5]);
    ...
    ((sort_kernel)[6] = malloc(
         (((0 == CD_type))
              ? (sizeof(c_gpu_sort_one_grid_x_vlo_6_struct))
              : ((((1 == CD_type))
                      ? (sizeof(openmp_gpu_sort_one_grid_x_vlo_6_struct))
                      : ((((2 == CD_type))
                              ? (sizeof(cuda_gpu_sort_one_grid_x_vlo_6_struct))
                              : (0))))))));
    ((sort_kernel)[7] = malloc(
         (((0 == CD_type))
              ? (sizeof(c_sort_one_grid_x_vlo_6_struct))
              : ((((1 == CD_type))
                      ? (sizeof(openmp_sort_one_grid_x_vlo_6_struct))
                      : ((((2 == CD_type))
                              ? (sizeof(cuda_sort_one_grid_x_vlo_6_struct))
                              : (0))))))));
    if ((0 == CD_type)) {
      c_gpu_sort_one_grid_x_vlo_6_init(pe, (sort_kernel)[6]);

    } else {
      if ((1 == CD_type)) {
        openmp_gpu_sort_one_grid_x_vlo_6_init(pe, (sort_kernel)[6]);
    ...
    if ((0 == CD_type)) {
      c_sort_one_grid_x_vlo_6_init(pe, (sort_kernel)[7]);

    } else {
      if ((1 == CD_type)) {
        openmp_sort_one_grid_x_vlo_6_init(pe, (sort_kernel)[7]);
    ...
    ((sort_kernel)[8] = malloc(
         (((0 == CD_type))
              ? (sizeof(c_gpu_sort_one_grid_y_vlo_6_struct))
              : ((((1 == CD_type))
                      ? (sizeof(openmp_gpu_sort_one_grid_y_vlo_6_struct))
                      : ((((2 == CD_type))
                              ? (sizeof(cuda_gpu_sort_one_grid_y_vlo_6_struct))
                              : (0))))))));
    ((sort_kernel)[9] = malloc(
         (((0 == CD_type))
              ? (sizeof(c_sort_one_grid_y_vlo_6_struct))
              : ((((1 == CD_type))
                      ? (sizeof(openmp_sort_one_grid_y_vlo_6_struct))
                      : ((((2 == CD_type))
                              ? (sizeof(cuda_sort_one_grid_y_vlo_6_struct))
                              : (0))))))));
    if ((0 == CD_type)) {
      c_gpu_sort_one_grid_y_vlo_6_init(pe, (sort_kernel)[8]);

    } else {
      if ((1 == CD_type)) {
        openmp_gpu_sort_one_grid_y_vlo_6_init(pe, (sort_kernel)[8]);
    ...
    if ((0 == CD_type)) {
      c_sort_one_grid_y_vlo_6_init(pe, (sort_kernel)[9]);

    } else {
      if ((1 == CD_type)) {
        openmp_sort_one_grid_y_vlo_6_init(pe, (sort_kernel)[9]);
    ...
    ((sort_kernel)[10] = malloc(
         (((0 == CD_type))
              ? (sizeof(c_gpu_sort_one_grid_z_vlo_6_struct))
              : ((((1 == CD_type))
                      ? (sizeof(openmp_gpu_sort_one_grid_z_vlo_6_struct))
                      : ((((2 == CD_type))
                              ? (sizeof(cuda_gpu_sort_one_grid_z_vlo_6_struct))
                              : (0))))))));
    ((sort_kernel)[11] = malloc(
         (((0 == CD_type))
              ? (sizeof(c_sort_one_grid_z_vlo_6_struct))
              : ((((1 == CD_type))
                      ? (sizeof(openmp_sort_one_grid_z_vlo_6_struct))
                      : ((((2 == CD_type))
                              ? (sizeof(cuda_sort_one_grid_z_vlo_6_struct))
                              : (0))))))));
    if ((0 == CD_type)) {
      c_gpu_sort_one_grid_z_vlo_6_init(pe, (sort_kernel)[10]);

    } else {
      if ((1 == CD_type)) {
        openmp_gpu_sort_one_grid_z_vlo_6_init(pe, (sort_kernel)[10]);
    ...
    if ((0 == CD_type)) {
      c_sort_one_grid_z_vlo_6_init(pe, (sort_kernel)[11]);

    } else {
      if ((1 == CD_type)) {
        openmp_sort_one_grid_z_vlo_6_init(pe, (sort_kernel)[11]);
    ...
    ((sort_kernel)[12] = malloc(
         (((0 == CD_type))
              ? (sizeof(c_gpu_sort_one_grid_x_8_struct))
              : ((((1 == CD_type))
                      ? (sizeof(openmp_gpu_sort_one_grid_x_8_struct))
                      : ((((2 == CD_type))
                              ? (sizeof(cuda_gpu_sort_one_grid_x_8_struct))
                              : (0))))))));
    ((sort_kernel)[13] =
         malloc((((0 == CD_type))
                     ? (sizeof(c_sort_one_grid_x_8_struct))
                     : ((((1 == CD_type))
                             ? (sizeof(openmp_sort_one_grid_x_8_struct))
                             : ((((2 == CD_type))
                                     ? (sizeof(cuda_sort_one_grid_x_8_struct))
                                     : (0))))))));
    if ((0 == CD_type)) {
      c_gpu_sort_one_grid_x_8_init(pe, (sort_kernel)[12]);

    } else {
      if ((1 == CD_type)) {
        openmp_gpu_sort_one_grid_x_8_init(pe, (sort_kernel)[12]);
    ...
    if ((0 == CD_type)) {
      c_sort_one_grid_x_8_init(pe, (sort_kernel)[13]);

    } else {
      if ((1 == CD_type)) {
        openmp_sort_one_grid_x_8_init(pe, (sort_kernel)[13]);
    ...
    ((sort_kernel)[14] = malloc(
         (((0 == CD_type))
              ? (sizeof(c_gpu_sort_one_grid_y_8_struct))
              : ((((1 == CD_type))
                      ? (sizeof(openmp_gpu_sort_one_grid_y_8_struct))
                      : ((((2 == CD_type))
                              ? (sizeof(cuda_gpu_sort_one_grid_y_8_struct))
                              : (0))))))));
    ((sort_kernel)[15] =
         malloc((((0 == CD_type))
                     ? (sizeof(c_sort_one_grid_y_8_struct))
                     : ((((1 == CD_type))
                             ? (sizeof(openmp_sort_one_grid_y_8_struct))
                             : ((((2 == CD_type))
                                     ? (sizeof(cuda_sort_one_grid_y_8_struct))
                                     : (0))))))));
    if ((0 == CD_type)) {
      c_gpu_sort_one_grid_y_8_init(pe, (sort_kernel)[14]);

    } else {
      if ((1 == CD_type)) {
        openmp_gpu_sort_one_grid_y_8_init(pe, (sort_kernel)[14]);
    ...
    if ((0 == CD_type)) {
      c_sort_one_grid_y_8_init(pe, (sort_kernel)[15]);

    } else {
      if ((1 == CD_type)) {
        openmp_sort_one_grid_y_8_init(pe, (sort_kernel)[15]);
    ...
    ((sort_kernel)[16] = malloc(
         (((0 == CD_type))
              ? (sizeof(c_gpu_sort_one_grid_z_8_struct))
              : ((((1 == CD_type))
                      ? (sizeof(openmp_gpu_sort_one_grid_z_8_struct))
                      : ((((2 == CD_type))
                              ? (sizeof(cuda_gpu_sort_one_grid_z_8_struct))
                              : (0))))))));
    ((sort_kernel)[17] =
         malloc((((0 == CD_type))
                     ? (sizeof(c_sort_one_grid_z_8_struct))
                     : ((((1 == CD_type))
                             ? (sizeof(openmp_sort_one_grid_z_8_struct))
                             : ((((2 == CD_type))
                                     ? (sizeof(cuda_sort_one_grid_z_8_struct))
                                     : (0))))))));
    if ((0 == CD_type)) {
      c_gpu_sort_one_grid_z_8_init(pe, (sort_kernel)[16]);

    } else {
      if ((1 == CD_type)) {
        openmp_gpu_sort_one_grid_z_8_init(pe, (sort_kernel)[16]);
    ...
    if ((0 == CD_type)) {
      c_sort_one_grid_z_8_init(pe, (sort_kernel)[17]);

    } else {
      if ((1 == CD_type)) {
        openmp_sort_one_grid_z_8_init(pe, (sort_kernel)[17]);
    ...
    ((sort_kernel)[18] = malloc(
         (((0 == CD_type))
              ? (sizeof(c_gpu_sort_one_grid_x_vlo_8_struct))
              : ((((1 == CD_type))
                      ? (sizeof(openmp_gpu_sort_one_grid_x_vlo_8_struct))
                      : ((((2 == CD_type))
                              ? (sizeof(cuda_gpu_sort_one_grid_x_vlo_8_struct))
                              : (0))))))));
    ((sort_kernel)[19] = malloc(
         (((0 == CD_type))
              ? (sizeof(c_sort_one_grid_x_vlo_8_struct))
              : ((((1 == CD_type))
                      ? (sizeof(openmp_sort_one_grid_x_vlo_8_struct))
                      : ((((2 == CD_type))
                              ? (sizeof(cuda_sort_one_grid_x_vlo_8_struct))
                              : (0))))))));
    if ((0 == CD_type)) {
      c_gpu_sort_one_grid_x_vlo_8_init(pe, (sort_kernel)[18]);

    } else {
      if ((1 == CD_type)) {
        openmp_gpu_sort_one_grid_x_vlo_8_init(pe, (sort_kernel)[18]);
    ...
    if ((0 == CD_type)) {
      c_sort_one_grid_x_vlo_8_init(pe, (sort_kernel)[19]);

    } else {
      if ((1 == CD_type)) {
        openmp_sort_one_grid_x_vlo_8_init(pe, (sort_kernel)[19]);
    ...
    ((sort_kernel)[20] = malloc(
         (((0 == CD_type))
              ? (sizeof(c_gpu_sort_one_grid_y_vlo_8_struct))
              : ((((1 == CD_type))
                      ? (sizeof(openmp_gpu_sort_one_grid_y_vlo_8_struct))
                      : ((((2 == CD_type))
                              ? (sizeof(cuda_gpu_sort_one_grid_y_vlo_8_struct))
                              : (0))))))));
    ((sort_kernel)[21] = malloc(
         (((0 == CD_type))
              ? (sizeof(c_sort_one_grid_y_vlo_8_struct))
              : ((((1 == CD_type))
                      ? (sizeof(openmp_sort_one_grid_y_vlo_8_struct))
                      : ((((2 == CD_type))
                              ? (sizeof(cuda_sort_one_grid_y_vlo_8_struct))
                              : (0))))))));
    if ((0 == CD_type)) {
      c_gpu_sort_one_grid_y_vlo_8_init(pe, (sort_kernel)[20]);

    } else {
      if ((1 == CD_type)) {
        openmp_gpu_sort_one_grid_y_vlo_8_init(pe, (sort_kernel)[20]);
    ...
    if ((0 == CD_type)) {
      c_sort_one_grid_y_vlo_8_init(pe, (sort_kernel)[21]);

    } else {
      if ((1 == CD_type)) {
        openmp_sort_one_grid_y_vlo_8_init(pe, (sort_kernel)[21]);
    ...
    ((sort_kernel)[22] = malloc(
         (((0 == CD_type))
              ? (sizeof(c_gpu_sort_one_grid_z_vlo_8_struct))
              : ((((1 == CD_type))
                      ? (sizeof(openmp_gpu_sort_one_grid_z_vlo_8_struct))
                      : ((((2 == CD_type))
                              ? (sizeof(cuda_gpu_sort_one_grid_z_vlo_8_struct))
                              : (0))))))));
    ((sort_kernel)[23] = malloc(
         (((0 == CD_type))
              ? (sizeof(c_sort_one_grid_z_vlo_8_struct))
              : ((((1 == CD_type))
                      ? (sizeof(openmp_sort_one_grid_z_vlo_8_struct))
                      : ((((2 == CD_type))
                              ? (sizeof(cuda_sort_one_grid_z_vlo_8_struct))
                              : (0))))))));
    if ((0 == CD_type)) {
      c_gpu_sort_one_grid_z_vlo_8_init(pe, (sort_kernel)[22]);

    } else {
      if ((1 == CD_type)) {
        openmp_gpu_sort_one_grid_z_vlo_8_init(pe, (sort_kernel)[22]);
    ...
    if ((0 == CD_type)) {
      c_sort_one_grid_z_vlo_8_init(pe, (sort_kernel)[23]);

    } else {
      if ((1 == CD_type)) {
        openmp_sort_one_grid_z_vlo_8_init(pe, (sort_kernel)[23]);
...

    {
      if ((0 == CD_type)) {
        c_pscmc_mem_init(
            pe, (pthis)->inoutput, PS_DOUBLE_NUM,
            (6 * (grid_cache_len * (xlen * (ylen * (zlen * numvec))))));

      } else {
        if ((1 == CD_type)) {
          openmp_pscmc_mem_init(
              pe, (pthis)->inoutput, PS_DOUBLE_NUM,
              (6 * (grid_cache_len * (xlen * (ylen * (zlen * numvec))))));
    ...
    {
      if ((0 == CD_type)) {
        c_pscmc_mem_init(pe, (pthis)->xyzw, PS_INT_NUM,
                         (4 * (xlen * (ylen * (zlen * numvec)))));

      } else {
        if ((1 == CD_type)) {
          openmp_pscmc_mem_init(pe, (pthis)->xyzw, PS_INT_NUM,
                                (4 * (xlen * (ylen * (zlen * numvec)))));

        } else {
          if ((2 == CD_type)) {
            cuda_pscmc_mem_init(pe, (pthis)->xyzw, PS_INT_NUM,
                                (4 * (xlen * (ylen * (zlen * numvec)))));
      ...
      memset(tmp_h_data, 0,
             (sizeof(int) * (4 * (xlen * (ylen * (zlen * numvec))))));
    }
    {
      if ((0 == CD_type)) {
        c_pscmc_mem_init(pe, (pthis)->cu_cache, PS_DOUBLE_NUM,
                         (6 * (cu_cache_length * numvec)));

      } else {
        if ((1 == CD_type)) {
          openmp_pscmc_mem_init(pe, (pthis)->cu_cache, PS_DOUBLE_NUM,
                                (6 * (cu_cache_length * numvec)));

        } else {
          if ((2 == CD_type)) {
            cuda_pscmc_mem_init(pe, (pthis)->cu_cache, PS_DOUBLE_NUM,
                                (6 * (cu_cache_length * numvec)));
      ...
      memset(tmp_h_data, 0,
             (sizeof(double) * (6 * (cu_cache_length * numvec))));
    }
    {
      if ((0 == CD_type)) {
    ...
    {
      if ((0 == CD_type)) {
        c_pscmc_mem_init(pe, (pthis)->adjoint_vec_pids, PS_LONG_NUM,
                         (numvec * 6));

      } else {
        if ((1 == CD_type)) {
          openmp_pscmc_mem_init(pe, (pthis)->adjoint_vec_pids, PS_LONG_NUM,
                                (numvec * 6));

        } else {
          if ((2 == CD_type)) {
            cuda_pscmc_mem_init(pe, (pthis)->adjoint_vec_pids, PS_LONG_NUM,
                                (numvec * 6));
    ...
    }
    {
      ...
      void *split_pass_E_particle_kernel =
          (pthis)->split_pass_E_particle_kernel;
...
int delete_particle(One_Particle_Collection *pthis) {
  ...
  if ((0 == CD_type)) {
    ...
    if ((1 == CD_type)) {
      ...
      if ((2 == CD_type)) {
        cuda_pscmc_mem_destroy(inoutput);
  ...
  if ((0 == CD_type)) {
    ...
    if ((1 == CD_type)) {
      ...
      if ((2 == CD_type)) {
        cuda_pscmc_mem_destroy(cu_cache);
  ...
  if ((0 == CD_type)) {
    ...
    if ((1 == CD_type)) {
      ...
      if ((2 == CD_type)) {
        cuda_pscmc_mem_destroy(cu_xyzw);
  ...
  if ((0 == CD_type)) {
    ...
    if ((1 == CD_type)) {
      ...
      if ((2 == CD_type)) {
        cuda_pscmc_mem_destroy(adjoint_vec_pids);
...
int init_particle_mpi(Field3D_MPI *pthis, int num_spec, double *Mass,
                      double *Charge, double *Number_particle_per_marker,
                      long *grid_cache_len, long *cu_cache_length) {
  ((pthis)->num_spec = num_spec);
  long num_runtime = (pthis)->num_runtime;

  ((pthis)->particles =
       malloc((sizeof(One_Particle_Collection) * (num_spec * num_runtime))));
  int i;
  ...
  for (i = 0; (i < num_spec); i++) {
    for (j = 0; (j < num_runtime); j++) {
      ...
      void **dm8x8_kernels = (((pthis)->data + j))->dm8x8_kernels;

      void **geo_yeefdtd_kernels = (((pthis)->data + j))->geo_yeefdtd_kernels;

      void **geo_yeefdtd_rect_kernels =
          (((pthis)->data + j))->geo_yeefdtd_rect_kernels;

      void **yeefdtd_stencil_kernels =
          (((pthis)->data + j))->yeefdtd_stencil_kernels;
      ...
      void *blas_yiszero_synced_kernel =
          (((pthis)->data + j))->blas_yiszero_synced_kernel;

      void *blas_mulxy_numele3_kernel =
          (((pthis)->data + j))->blas_mulxy_numele3_kernel;

      void *blas_yiszero_kernel = (((pthis)->data + j))->blas_yiszero_kernel;

      void *blas_yiszero_full_block_kernel =
          (((pthis)->data + j))->blas_yiszero_full_block_kernel;

      void *blas_yisconst_kernel = (((pthis)->data + j))->blas_yisconst_kernel;

      void *blas_yisconst_full_block_kernel =
          (((pthis)->data + j))->blas_yisconst_full_block_kernel;

      void *blas_get_ITG_Potential_kernel =
          (((pthis)->data + j))->blas_get_ITG_Potential_kernel;

      void *blas_get_ITG_Potential_full_block_kernel =
          (((pthis)->data + j))->blas_get_ITG_Potential_full_block_kernel;

      void *blas_invy_kernel = (((pthis)->data + j))->blas_invy_kernel;

      void *blas_invy_full_block_kernel =
          (((pthis)->data + j))->blas_invy_full_block_kernel;

      void *blas_axpby_kernel = (((pthis)->data + j))->blas_axpby_kernel;

      void *blas_axpby_full_block_kernel =
          (((pthis)->data + j))->blas_axpby_full_block_kernel;

      void *blas_axpy_kernel = (((pthis)->data + j))->blas_axpy_kernel;

      void *blas_axpy_full_block_kernel =
          (((pthis)->data + j))->blas_axpy_full_block_kernel;

      void *blas_yisax_kernel = (((pthis)->data + j))->blas_yisax_kernel;

      void *blas_yisax_full_block_kernel =
          (((pthis)->data + j))->blas_yisax_full_block_kernel;

      void *blas_mulxy_kernel = (((pthis)->data + j))->blas_mulxy_kernel;

      void *blas_mulxy_full_block_kernel =
          (((pthis)->data + j))->blas_mulxy_full_block_kernel;

      void *blas_findmax_kernel = (((pthis)->data + j))->blas_findmax_kernel;

      void *blas_findmax_full_block_kernel =
          (((pthis)->data + j))->blas_findmax_full_block_kernel;

      void *blas_dot_kernel = (((pthis)->data + j))->blas_dot_kernel;

      void *blas_dot_full_block_kernel =
          (((pthis)->data + j))->blas_dot_full_block_kernel;

      void *blas_sum_kernel = (((pthis)->data + j))->blas_sum_kernel;

      void *blas_sum_full_block_kernel =
          (((pthis)->data + j))->blas_sum_full_block_kernel;

      void *blas_yisax_shrink_kernel =
          (((pthis)->data + j))->blas_yisax_shrink_kernel;

      void *blas_yisax_enlarge_kernel =
          (((pthis)->data + j))->blas_yisax_enlarge_kernel;

      void *blas_axpy_shrink_kernel =
          (((pthis)->data + j))->blas_axpy_shrink_kernel;

      void *blas_axpy_enlarge_kernel =
          (((pthis)->data + j))->blas_axpy_enlarge_kernel;

      void *blas_axpby_shrink_kernel =
          (((pthis)->data + j))->blas_axpby_shrink_kernel;

      void *blas_axpby_enlarge_kernel =
          (((pthis)->data + j))->blas_axpby_enlarge_kernel;

      //====================Field3D_Seq
      init_particle(((pthis)->particles + ((i * num_runtime) + j)),
                    ((pthis)->data + j), (Mass)[i], (Charge)[i],
                    ...
                    ((grid_cache_len)[i] * ((USE_NON_UNI_CACHE_DIST) ? (({
...

                       {
                         ...
                         for ((k = 0); (k < numvec); (k = (k + 1))) {
                           double new_cplx =
                               call_GET_NON_UNI_CACHE_DIST(i, (global_id)[k]);
...
int generate_random_particle_mpi(Field3D_MPI *pthis) {
  ...
  for (i = 0; (i < num_spec); i++) {
    for (j = 0; (j < num_runtime); j++) {
      generate_random_self_particle(
          ((pthis)->particles + ((i * num_runtime) + j)));
    }
  }
  return 0;
}
...
int generate_random_self_particle(One_Particle_Collection *pthis) {
  ...
  //====================One_Particle_Collection
  {
    ...
    for (cur_pcid = 0; (cur_pcid < numvec); cur_pcid++) {
      double *grid_r_0 =
          (host_data + (cur_pcid * (alllenoff * (6 * grid_cache_len))));
            ...
            for ((xyzy = 0); (xyzy < ylen); (xyzy = (xyzy + 1))) {
              {
                ...
                for ((xyzx = 0); (xyzx < xlen); (xyzx = (xyzx + 1))) {
                  double *grid_r =
                      (grid_r_0 +
                       (0 + ((6 * grid_cache_len) *
                             (xyzx + (xlen * (xyzy + (ylen * xyzz)))))));

                  int *grid_xyzw =
                      (xyzw_0 +
                       (0 + (4 * (xyzx + (xlen * (xyzy + (ylen * xyzz)))))));
...
int init_maxwell_dist_particle_opc(One_Particle_Collection *pthis,
                                   int tgrid_load, double VT, int use_lost_cone,
                                   double mu0, double delta, int ptlen) {
            ...
            for ((xyzy = 0); (xyzy < ylen); (xyzy = (xyzy + 1))) {
              {
                ...
                for ((xyzx = 0); (xyzx < xlen); (xyzx = (xyzx + 1))) {
                  ...
                  if ((grid_load > grid_cache_len)) {
                    fprintf(stderr,
                            "Error, gl=%ld gcl=%ld global_id=%ld cur_picid=%ld\n",
                            grid_load, grid_cache_len, (global_id)[cur_pcid],
                            cur_pcid);
...
int init_maxwell_dist_particle_fmpi(Field3D_MPI *pthis) {
  ...
  for (i = 0; (i < num_spec); i++) {
    ...
    if ((((((Particle_in_Cell_MPI *)pthis))->o_particle_type)[i] != 1)) {
      fprintf(stderr, "info init_maxwell_dist_particle_fmpi: spec=%d\n", i);
      for (j = 0; (j < num_runtime); j++) {
        init_maxwell_dist_particle_opc(
            ((pthis)->particles + ((i * num_runtime) + j)),
            call_GET_INIT_LOAD(i), call_GET_INIT_VT(i),
            (((i == 0)) ? (use_lost_cone) : (0)), mu0, delta, ptlen);
      }
...
int init_user_defined_particle_opc(One_Particle_Collection *pthis,
                                   int tgrid_load, int cur_sp, double vt,
                                   int external_para, int ptlen) {
            ...
            for ((xyzy = 0); (xyzy < ylen); (xyzy = (xyzy + 1))) {
              {
                ...
                for ((xyzx = 0); (xyzx < xlen); (xyzx = (xyzx + 1))) {
                  ...
                  long grid_load =
                      (((USE_NON_UNI_DENSITY)
                            ? (call_GET_INIT_DENSITY_DIST(
                                  cur_sp,
                                  ((global_z_offset)[cur_pcid] +
                                   (xyzz + 5.00000000000000000e-01)),
                                  ((global_y_offset)[cur_pcid] +
                                   (xyzy + 5.00000000000000000e-01)),
                                  ((global_x_offset)[cur_pcid] +
                                   (xyzx + 5.00000000000000000e-01))))
                            : (1)) *
                       tgrid_load);
                  ...
                  for (l; (l < grid_load); l++) {
                    ...
                    user_defined_particle_distribution(
                        xyzvs, ((global_x_offset)[cur_pcid] + xyzx),
                        ((global_y_offset)[cur_pcid] + xyzy),
                        ((global_z_offset)[cur_pcid] + xyzz), cur_sp, l,
                        tgrid_load, external_para);
                    double lx = (xyzvs)[0];
                    ...
                    ((xyzvs)[0] = ((xyzvs)[0] + xyzx));
                    ((xyzvs)[1] = ((xyzvs)[1] + xyzy));
                    ((xyzvs)[2] = ((xyzvs)[2] + xyzz));
                  }
                }
              }
            }
...
int init_user_defined_particle_fmpi(Field3D_MPI *pthis) {
  ...
  for (i = 0; (i < num_spec); i++) {
    ...
    if ((((((Particle_in_Cell_MPI *)pthis))->o_particle_type)[i] != 1)) {
      fprintf(stderr, "info init_user_defined_particle_fmpi: spec=%d\n", i);
      for (j = 0; (j < num_runtime); j++) {
        init_user_defined_particle_opc(
            ((pthis)->particles + ((i * num_runtime) + j)),
            call_GET_INIT_LOAD(i), i, call_GET_INIT_VT(i), 0, ptlen);
      }
...
int init_non_uni_particle_opc(One_Particle_Collection *pthis, int tgrid_load,
                              int cur_sp, double VT, double vmax, int ptlen) {
...
int init_non_uni_particle_fmpi(Field3D_MPI *pthis, double vmax) {
  ...
  for (i = 0; (i < num_spec); i++) {
    ...
    if ((((((Particle_in_Cell_MPI *)pthis))->o_particle_type)[i] != 1)) {
      ...
      for (j = 0; (j < num_runtime); j++) {
        init_non_uni_particle_opc(
            ((pthis)->particles + ((i * num_runtime) + j)),
            call_GET_INIT_LOAD(i), i, call_GET_INIT_VT(i), vmax, ptlen);
      }
...
int init_single_particle_fmpi(Field3D_MPI *pthis) {
  ...
  for (i = 0; (i < num_spec); i++) {
    ...
    if ((((((Particle_in_Cell_MPI *)pthis))->o_particle_type)[i] != 1)) {
      fprintf(stderr, "info init_single_particle_fmpi: spec=%d\n", i);
      for (j = 0; (j < num_runtime); j++) {
        init_single_particle_opc(((pthis)->particles + ((i * num_runtime) + j)),
                                 (((j == 0)) ? (1) : (0)), ptlen);
      }
...
void init_global_particles(Particle_in_Cell_MPI *pthis, Field3D_MPI *fE,
                           Field3D_MPI *fE2x, Field3D_MPI *fEN,
                           int use_small_num_grids, int pml_abc_dir,
                           int pml_level, double pml_sigma_max, double deltat,
                           int num_spec, long *allxyzmax, double *massp,
                           double *chargep, double *npm, long *grid_cache_len,
                           long *cu_cache_len, int *particle_types,
                           int reduce_dim, double r_x_rat, double r_y_rat,
                           double r_z_rat, double random_rate, int use_vlo_o,
                           int use_rel_ncr1) {
  ...
  if (pml_abc_dir) {
    ...
    blas_yiszero_Field3D_MPI(&((pthis)->MPI_fieldPMLB),
                             &((pthis)->MPI_fieldPMLB));
    blas_yiszero_Field3D_MPI(&((pthis)->MPI_fieldPMLE),
                             &((pthis)->MPI_fieldPMLE));
  ...
  if (USE_INIT_EXT_EB) {
    init_external_field3d_E_2d_extend(&((pthis)->MPI_fieldE_ext), reduce_dim,
                                      r_x_rat, r_y_rat, r_z_rat);
    init_external_field3d_B_2d_extend(&((pthis)->MPI_fieldB_ext), reduce_dim,
                                      (r_y_rat * r_z_rat), (r_x_rat * r_z_rat),
                                      (r_x_rat * r_y_rat));
  ...
  if (USE_INIT_EB0) {
    init_external_field3d_E0_2d_extend_rand(&((pthis)->MPI_fieldE), reduce_dim,
                                            r_x_rat, r_y_rat, r_z_rat,
                                            random_rate);
    init_external_field3d_B0_2d_extend_rand(
        &((pthis)->MPI_fieldB), reduce_dim, (r_y_rat * r_z_rat),
  ...
  blas_yisax_Field3D_MPI(&((pthis)->MPI_fieldB1), &((pthis)->MPI_fieldB1),
                         1.00000000000000000e+00, &((pthis)->MPI_fieldB));
  if (use_rel_ncr) {
    blas_yiszero_synced_Field3D_MPI(&((pthis)->MPI_fieldE01_2x),
                                    &((pthis)->MPI_fieldE01_2x));
    blas_yiszero_synced_Field3D_MPI(&((pthis)->MPI_fieldB0_2x),
                                    &((pthis)->MPI_fieldB0_2x));
    blas_yisax_enlarge_Field3D_MPI(
        &((pthis)->MPI_fieldE), &((pthis)->MPI_fieldE01_2x),
        1.00000000000000000e+00, &((pthis)->MPI_fieldE));
    blas_yisax_enlarge_Field3D_MPI(&((pthis)->MPI_fieldB),
                                   &((pthis)->MPI_fieldB0_2x), 1,
                                   &((pthis)->MPI_fieldB));
  ...
  init_particle_mpi(&((pthis)->MPI_fieldE), num_spec, massp, chargep, npm,
                    grid_cache_len, cu_cache_len);
...

  {
    ...
    for ((i = 0); (i < (num_spec * num_runtime)); (i = (i + 1))) {
      (((((pthis)->MPI_fieldE).particles + i))->pfieldE =
           (((pthis)->MPI_fieldE).data + (i % num_runtime)));
      (((((pthis)->MPI_fieldE).particles + i))->pfieldB =
           (((pthis)->MPI_fieldB).data + (i % num_runtime)));
      (((((pthis)->MPI_fieldE).particles + i))->pFoutJ =
           (((pthis)->MPI_FoutJ).data + (i % num_runtime)));
      (((((pthis)->MPI_fieldE).particles + i))->pLFoutJ =
           ((use_small_num_grids)
                ? ((((pthis)->MPI_LFoutJ).data + (i % num_runtime)))
                : (NULL)));
      (((((pthis)->MPI_fieldE).particles + i))->pFoutEN =
           (((pthis)->pMPI_FoutEN)->data + (i % num_runtime)));
    }
  }
  ((pthis)->dt = deltat);
}
