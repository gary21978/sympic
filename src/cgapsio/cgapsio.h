...
extern int *GAPS_IO_GlobalTypeLen;
int GAPS_IO_TruncateFile(Gaps_IO_DataFile *pOutfile, int64_t NumSteps, int64_t NumData);
...
int GAPS_IO_InitOFile_with_TimeStepV2_withrank(Gaps_IO_DataFile *pOutfile, char *pName, char *pNamePrefix,
