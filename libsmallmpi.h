...
int PS_MPI_Finalize();
int PS_MPI_Gather(void *sendbuf, int sendcount, MPI_Datatype sendtype,
                  void *recvbuf, int recvcount, MPI_Datatype recvtype, int root,
                  MPI_Comm comm);
int PS_MPI_Get_processor_name(char *name, int *resultlen);
int PS_MPI_Init(int *argc, char ***argv);
int PS_MPI_Send(void *buf, int count, MPI_Datatype datatype, int dest, int tag,
                MPI_Comm comm);
...
int PS_MPI_Reduce(void *buf, void *recvbuf, int count, MPI_Datatype datatype,
                  MPI_Op op, int root, MPI_Comm comm);
int PS_MPI_Sendrecv(void *sendbuf, int sendcount, MPI_Datatype sendtype,
