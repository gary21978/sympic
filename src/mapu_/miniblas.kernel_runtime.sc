...
#include "miniblas.kernel.inc"
    ...
    int mapu_blas_yiszero_full_block_init(mapu_pscmc_env *pe, mapu_blas_yiszero_full_block_struct *kerstr)
    {
        ((kerstr)->pe = pe);
        return 0;
    }
    int mapu_blas_yisconst_init(mapu_pscmc_env *pe, mapu_blas_yisconst_struct *kerstr)
    {
        ((kerstr)->pe = pe);
        return 0;
    }
    int mapu_blas_yisconst_full_block_init(mapu_pscmc_env *pe, mapu_blas_yisconst_full_block_struct *kerstr)
    {
        ((kerstr)->pe = pe);
        return 0;
    }
    int mapu_blas_get_ITG_Potential_init(mapu_pscmc_env *pe, mapu_blas_get_ITG_Potential_struct *kerstr)
    {
        ((kerstr)->pe = pe);
        return 0;
    }
    int mapu_blas_get_ITG_Potential_full_block_init(mapu_pscmc_env *pe, mapu_blas_get_ITG_Potential_full_block_struct *kerstr)
    {
        ((kerstr)->pe = pe);
        return 0;
    }
    ...
    int mapu_blas_invy_full_block_init(mapu_pscmc_env *pe, mapu_blas_invy_full_block_struct *kerstr)
    {
        ((kerstr)->pe = pe);
        return 0;
    }
    ...
    int mapu_blas_axpby_full_block_init(mapu_pscmc_env *pe, mapu_blas_axpby_full_block_struct *kerstr)
    {
        ((kerstr)->pe = pe);
        return 0;
    }
    int mapu_blas_axpy_full_block_init(mapu_pscmc_env *pe, mapu_blas_axpy_full_block_struct *kerstr)
    {
        ((kerstr)->pe = pe);
        return 0;
    }
    int mapu_blas_yisax_full_block_init(mapu_pscmc_env *pe, mapu_blas_yisax_full_block_struct *kerstr)
    {
        ((kerstr)->pe = pe);
        return 0;
    }
    ...
    int mapu_blas_mulxy_full_block_init(mapu_pscmc_env *pe, mapu_blas_mulxy_full_block_struct *kerstr)
    {
        ((kerstr)->pe = pe);
        return 0;
    }
    int mapu_blas_findmax_init(mapu_pscmc_env *pe, mapu_blas_findmax_struct *kerstr)
    {
        ((kerstr)->pe = pe);
        return 0;
    }
    int mapu_blas_findmax_full_block_init(mapu_pscmc_env *pe, mapu_blas_findmax_full_block_struct *kerstr)
    {
        ((kerstr)->pe = pe);
        return 0;
    }
    ...
    int mapu_blas_dot_full_block_init(mapu_pscmc_env *pe, mapu_blas_dot_full_block_struct *kerstr)
    {
        ((kerstr)->pe = pe);
        return 0;
    }
    ...
    int mapu_blas_sum_full_block_init(mapu_pscmc_env *pe, mapu_blas_sum_full_block_struct *kerstr)
    {
        ((kerstr)->pe = pe);
        return 0;
    }
    int mapu_blas_yisax_shrink_init(mapu_pscmc_env *pe, mapu_blas_yisax_shrink_struct *kerstr)
    {
        ((kerstr)->pe = pe);
        return 0;
    }
    int mapu_blas_axpy_enlarge_init(mapu_pscmc_env *pe, mapu_blas_axpy_enlarge_struct *kerstr)
    {
        ((kerstr)->pe = pe);
        return 0;
    }
    int mapu_blas_axpy_shrink_init(mapu_pscmc_env *pe, mapu_blas_axpy_shrink_struct *kerstr)
    {
        ((kerstr)->pe = pe);
        return 0;
    }
    int mapu_blas_axpby_shrink_init(mapu_pscmc_env *pe, mapu_blas_axpby_shrink_struct *kerstr)
    {
        ((kerstr)->pe = pe);
        return 0;
    }
    int mapu_blas_axpby_enlarge_init(mapu_pscmc_env *pe, mapu_blas_axpby_enlarge_struct *kerstr)
    {
        ((kerstr)->pe = pe);
        return 0;
    }
    int mapu_blas_mulxy_numele3_init(mapu_pscmc_env *pe, mapu_blas_mulxy_numele3_struct *kerstr)
    {
        ((kerstr)->pe = pe);
        return 0;
    }
    ...
    int mapu_blas_yisax_enlarge_init(mapu_pscmc_env *pe, mapu_blas_yisax_enlarge_struct *kerstr)
    {
        ((kerstr)->pe = pe);
        return 0;
    }
    ...
    {
        ((len)[0] = sizeof(mapu_blas_yisax_enlarge_struct));
    }
    int mapu_blas_yisax_enlarge_get_xlen()
    {
        return 1;
    }
    int mapu_blas_yisax_enlarge_get_num_compute_units(mapu_blas_yisax_enlarge_struct *kerstr)
    {
        return 4;
    }
...
__d_data_address_tmp2; })), (((double *)kerstr->a->h_data))[0], (((MAPU_LONG *)kerstr->y_cpu_core->h_data))[0], (((MAPU_LONG *)kerstr->numvec->h_data))[0], (((MAPU_LONG *)kerstr->XLEN->h_data))[0], (((MAPU_LONG *)kerstr->YLEN->h_data))[0], (((MAPU_LONG *)kerstr->ZLEN->h_data))[0], (((int *)kerstr->ovlp->h_data))[0], (((MAPU_LONG *)kerstr->xblock->h_data))[0], (((MAPU_LONG *)kerstr->yblock->h_data))[0], (((MAPU_LONG *)kerstr->zblock->h_data))[0], (((int *)kerstr->num_ele->h_data))[0]);
    ...
    {
        ((len)[0] = sizeof(mapu_blas_axpy_struct));
    }
    ...
    int mapu_blas_axpy_exec(mapu_blas_axpy_struct *kerstr, long scmc_internal_g_xlen, long scmc_internal_g_ylen)
    {
        ...
        {
            {
                mapu_blas_axpy<<<scmc_internal_g_ylen, scmc_internal_g_xlen>>>(((__DDR double *)({
	 uint64_t  __d_data_address_tmp2 ;
	mapsMemobjGetPhysicalAddress ( kerstr->y->d_data , & (__d_data_address_tmp2) );
__d_data_address_tmp2; })), ((__DDR double *)({
	 uint64_t  __d_data_address_tmp2 ;
...
__d_data_address_tmp2; })), (((double *)kerstr->a->h_data))[0], (((MAPU_LONG *)kerstr->y_cpu_core->h_data))[0], (((MAPU_LONG *)kerstr->numvec->h_data))[0], (((MAPU_LONG *)kerstr->XLEN->h_data))[0], (((MAPU_LONG *)kerstr->YLEN->h_data))[0], (((MAPU_LONG *)kerstr->ZLEN->h_data))[0], (((int *)kerstr->ovlp->h_data))[0], (((MAPU_LONG *)kerstr->xblock->h_data))[0], (((MAPU_LONG *)kerstr->yblock->h_data))[0], (((MAPU_LONG *)kerstr->zblock->h_data))[0], (((int *)kerstr->num_ele->h_data))[0]);
    ...
    {
        ((len)[0] = sizeof(mapu_blas_yisax_struct));
    }
...
__d_data_address_tmp2; })), (((double *)kerstr->a->h_data))[0], (((MAPU_LONG *)kerstr->y_cpu_core->h_data))[0], (((MAPU_LONG *)kerstr->numvec->h_data))[0], (((MAPU_LONG *)kerstr->XLEN->h_data))[0], (((MAPU_LONG *)kerstr->YLEN->h_data))[0], (((MAPU_LONG *)kerstr->ZLEN->h_data))[0], (((int *)kerstr->ovlp->h_data))[0], (((MAPU_LONG *)kerstr->xblock->h_data))[0], (((MAPU_LONG *)kerstr->yblock->h_data))[0], (((MAPU_LONG *)kerstr->zblock->h_data))[0], (((int *)kerstr->num_ele->h_data))[0]);
    ...
    int mapu_blas_yiszero_init(mapu_pscmc_env *pe, mapu_blas_yiszero_struct *kerstr)
    {
        ((kerstr)->pe = pe);
        return 0;
    }
    ...
    {
        ((len)[0] = sizeof(mapu_blas_yiszero_struct));
    }
...
__d_data_address_tmp2; })), (((MAPU_LONG *)kerstr->y_cpu_core->h_data))[0], (((MAPU_LONG *)kerstr->numvec->h_data))[0], (((MAPU_LONG *)kerstr->XLEN->h_data))[0], (((MAPU_LONG *)kerstr->YLEN->h_data))[0], (((MAPU_LONG *)kerstr->ZLEN->h_data))[0], (((int *)kerstr->ovlp->h_data))[0], (((MAPU_LONG *)kerstr->xblock->h_data))[0], (((MAPU_LONG *)kerstr->yblock->h_data))[0], (((MAPU_LONG *)kerstr->zblock->h_data))[0], (((int *)kerstr->num_ele->h_data))[0]);
    ...
    int mapu_blas_yiszero_synced_init(mapu_pscmc_env *pe, mapu_blas_yiszero_synced_struct *kerstr)
    {
        ((kerstr)->pe = pe);
        return 0;
    }
    ...
    {
        ((len)[0] = sizeof(mapu_blas_yiszero_synced_struct));
    }
    int mapu_blas_yiszero_synced_get_xlen()
    {
        return 1;
    }
    int mapu_blas_yiszero_synced_get_num_compute_units(mapu_blas_yiszero_synced_struct *kerstr)
    {
        return 4;
    }
